    ...
    VkDeviceMemory*                             pMemory)
{
    ...
    if (pAllocateInfo != NULL)
    {
        ...
        skipCall |= validate_struct_pnext(report_data, "vkAllocateMemory", "pAllocateInfo->pNext", "VkDedicatedAllocationMemoryAllocateInfoNV", pAllocateInfo->pNext, ARRAY_SIZE(allowedStructs), allowedStructs);
    }
    ...
    VkBuffer*                                   pBuffer)
{
    ...
    if (pCreateInfo != NULL)
    {
        ...
        skipCall |= validate_struct_pnext(report_data, "vkCreateBuffer", "pCreateInfo->pNext", "VkDedicatedAllocationBufferCreateInfoNV", pCreateInfo->pNext, ARRAY_SIZE(allowedStructs), allowedStructs);
    ...
    VkImage*                                    pImage)
{
    ...
    if (pCreateInfo != NULL)
    {
        ...
        skipCall |= validate_struct_pnext(report_data, "vkCreateImage", "pCreateInfo->pNext", "VkDedicatedAllocationImageCreateInfoNV", pCreateInfo->pNext, ARRAY_SIZE(allowedStructs), allowedStructs);
