...
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #982
...
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1010
...
VK_LAYER_EXPORT VKAPI_ATTR VkResult VKAPI_CALL vkCreateInstance(const VkInstanceCreateInfo* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkInstance* pInstance)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkCreateInstance(pCreateInfo = 0x" << nouppercase <<  hex << HandleCast(pCreateInfo) << dec << ", pAllocator = 0x" << nouppercase <<  hex << HandleCast(pAllocator) << dec << ", " << (pInstance ? "*" : "") << "pInstance = 0x" << nouppercase <<  hex << (pInstance ? HandleCast(*pInstance) : 0) << dec << ") = " << string_VkResult((VkResult)result) << endl;
    }
    else {
...
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1100
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1116
        if (pCreateInfo) {
...
VK_LAYER_EXPORT VKAPI_ATTR void VKAPI_CALL vkDestroyInstance(VkInstance instance, const VkAllocationCallbacks* pAllocator)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkDestroyInstance(instance = 0x" << nouppercase <<  hex << HandleCast(instance) << dec << ", pAllocator = 0x" << nouppercase <<  hex << HandleCast(pAllocator) << dec << ")\n";
    }
    else {
...
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
        uint32_t i;
        if (pPhysicalDevices) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1139
...
VK_LAYER_EXPORT VKAPI_ATTR void VKAPI_CALL vkGetPhysicalDeviceFeatures(VkPhysicalDevice physicalDevice, VkPhysicalDeviceFeatures* pFeatures)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkGetPhysicalDeviceFeatures(physicalDevice = 0x" << nouppercase <<  hex << HandleCast(physicalDevice) << dec << ", pFeatures = 0x" << nouppercase <<  hex << HandleCast(pFeatures) << dec << ")\n";
    }
    else {
...
VK_LAYER_EXPORT VKAPI_ATTR void VKAPI_CALL vkGetPhysicalDeviceFormatProperties(VkPhysicalDevice physicalDevice, VkFormat format, VkFormatProperties* pFormatProperties)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkGetPhysicalDeviceFormatProperties(physicalDevice = 0x" << nouppercase <<  hex << HandleCast(physicalDevice) << dec << ", format = " << string_VkFormat(format) << ", pFormatProperties = 0x" << nouppercase <<  hex << HandleCast(pFormatProperties) << dec << ")\n";
    }
    else {
...
VK_LAYER_EXPORT VKAPI_ATTR VkResult VKAPI_CALL vkGetPhysicalDeviceImageFormatProperties(VkPhysicalDevice physicalDevice, VkFormat format, VkImageType type, VkImageTiling tiling, VkImageUsageFlags usage, VkImageCreateFlags flags, VkImageFormatProperties* pImageFormatProperties)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkGetPhysicalDeviceImageFormatProperties(physicalDevice = 0x" << nouppercase <<  hex << HandleCast(physicalDevice) << dec << ", format = " << string_VkFormat(format) << ", type = " << string_VkImageType(type) << ", tiling = " << string_VkImageTiling(tiling) << ", usage = 0x" << nouppercase <<  hex << usage << dec << ", flags = 0x" << nouppercase <<  hex << flags << dec << ", pImageFormatProperties = 0x" << nouppercase <<  hex << HandleCast(pImageFormatProperties) << dec << ") = " << string_VkResult((VkResult)result) << endl;
    }
    else {
        (*outputStream) << "t{" << getTIDIndex() << "} vkGetPhysicalDeviceImageFormatProperties(physicalDevice = address, format = " << string_VkFormat(format) << ", type = " << string_VkImageType(type) << ", tiling = " << string_VkImageTiling(tiling) << ", usage = address, flags = address, pImageFormatProperties = address) = " << string_VkResult((VkResult)result) << endl;
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1100
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
...
VK_LAYER_EXPORT VKAPI_ATTR void VKAPI_CALL vkGetPhysicalDeviceProperties(VkPhysicalDevice physicalDevice, VkPhysicalDeviceProperties* pProperties)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkGetPhysicalDeviceProperties(physicalDevice = 0x" << nouppercase <<  hex << HandleCast(physicalDevice) << dec << ", pProperties = 0x" << nouppercase <<  hex << HandleCast(pProperties) << dec << ")\n";
    }
    else {
...
VK_LAYER_EXPORT VKAPI_ATTR void VKAPI_CALL vkGetPhysicalDeviceMemoryProperties(VkPhysicalDevice physicalDevice, VkPhysicalDeviceMemoryProperties* pMemoryProperties)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkGetPhysicalDeviceMemoryProperties(physicalDevice = 0x" << nouppercase <<  hex << HandleCast(physicalDevice) << dec << ", pMemoryProperties = 0x" << nouppercase <<  hex << HandleCast(pMemoryProperties) << dec << ")\n";
    }
    else {
...
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1194
...
VK_LAYER_EXPORT VKAPI_ATTR VkResult VKAPI_CALL vkCreateDevice(VkPhysicalDevice physicalDevice, const VkDeviceCreateInfo* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkDevice* pDevice)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkCreateDevice(physicalDevice = 0x" << nouppercase <<  hex << HandleCast(physicalDevice) << dec << ", pCreateInfo = 0x" << nouppercase <<  hex << HandleCast(pCreateInfo) << dec << ", pAllocator = 0x" << nouppercase <<  hex << HandleCast(pAllocator) << dec << ", " << (pDevice ? "*" : "") << "pDevice = 0x" << nouppercase <<  hex << (pDevice ? HandleCast(*pDevice) : 0) << dec << ") = " << string_VkResult((VkResult)result) << endl;
    }
    else {
...
VK_LAYER_EXPORT VKAPI_ATTR void VKAPI_CALL vkDestroyDevice(VkDevice device, const VkAllocationCallbacks* pAllocator)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkDestroyDevice(device = 0x" << nouppercase <<  hex << HandleCast(device) << dec << ", pAllocator = 0x" << nouppercase <<  hex << HandleCast(pAllocator) << dec << ")\n";
    }
    else {
...
VK_LAYER_EXPORT VKAPI_ATTR void VKAPI_CALL vkGetDeviceQueue(VkDevice device, uint32_t queueFamilyIndex, uint32_t queueIndex, VkQueue* pQueue)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkGetDeviceQueue(device = 0x" << nouppercase <<  hex << HandleCast(device) << dec << ", queueFamilyIndex = 0x" << nouppercase <<  hex << queueFamilyIndex << dec << ", queueIndex = 0x" << nouppercase <<  hex << queueIndex << dec << ", " << (pQueue ? "*" : "") << "pQueue = 0x" << nouppercase <<  hex << (pQueue ? HandleCast(*pQueue) : 0) << dec << ")\n";
    }
    else {
        (*outputStream) << "t{" << getTIDIndex() << "} vkGetDeviceQueue(device = address, queueFamilyIndex = address, queueIndex = address, pQueue = address)\n";
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1100
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
...
VK_LAYER_EXPORT VKAPI_ATTR VkResult VKAPI_CALL vkQueueSubmit(VkQueue queue, uint32_t submitCount, const VkSubmitInfo* pSubmits, VkFence fence)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkQueueSubmit(queue = 0x" << nouppercase <<  hex << HandleCast(queue) << dec << ", submitCount = 0x" << nouppercase <<  hex << submitCount << dec << ", pSubmits = 0x" << nouppercase <<  hex << HandleCast(pSubmits) << dec << ", fence = 0x" << nouppercase <<  hex << HandleCast(fence) << dec << ") = " << string_VkResult((VkResult)result) << endl;
    }
    else {
        (*outputStream) << "t{" << getTIDIndex() << "} vkQueueSubmit(queue = address, submitCount = address, pSubmits = address, fence = address) = " << string_VkResult((VkResult)result) << endl;
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1100
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
...
VK_LAYER_EXPORT VKAPI_ATTR VkResult VKAPI_CALL vkQueueWaitIdle(VkQueue queue)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkQueueWaitIdle(queue = 0x" << nouppercase <<  hex << HandleCast(queue) << dec << ") = " << string_VkResult((VkResult)result) << endl;
    }
    else {
...
VK_LAYER_EXPORT VKAPI_ATTR VkResult VKAPI_CALL vkDeviceWaitIdle(VkDevice device)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkDeviceWaitIdle(device = 0x" << nouppercase <<  hex << HandleCast(device) << dec << ") = " << string_VkResult((VkResult)result) << endl;
    }
    else {
...
VK_LAYER_EXPORT VKAPI_ATTR VkResult VKAPI_CALL vkAllocateMemory(VkDevice device, const VkMemoryAllocateInfo* pAllocateInfo, const VkAllocationCallbacks* pAllocator, VkDeviceMemory* pMemory)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkAllocateMemory(device = 0x" << nouppercase <<  hex << HandleCast(device) << dec << ", pAllocateInfo = 0x" << nouppercase <<  hex << HandleCast(pAllocateInfo) << dec << ", pAllocator = 0x" << nouppercase <<  hex << HandleCast(pAllocator) << dec << ", " << (pMemory ? "*" : "") << "pMemory = 0x" << nouppercase <<  hex << (pMemory ? HandleCast(*pMemory) : 0) << dec << ") = " << string_VkResult((VkResult)result) << endl;
    }
    else {
        (*outputStream) << "t{" << getTIDIndex() << "} vkAllocateMemory(device = address, pAllocateInfo = address, pAllocator = address, pMemory = address) = " << string_VkResult((VkResult)result) << endl;
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1100
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
...
VK_LAYER_EXPORT VKAPI_ATTR void VKAPI_CALL vkFreeMemory(VkDevice device, VkDeviceMemory memory, const VkAllocationCallbacks* pAllocator)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkFreeMemory(device = 0x" << nouppercase <<  hex << HandleCast(device) << dec << ", memory = 0x" << nouppercase <<  hex << HandleCast(memory) << dec << ", pAllocator = 0x" << nouppercase <<  hex << HandleCast(pAllocator) << dec << ")\n";
    }
    else {
        (*outputStream) << "t{" << getTIDIndex() << "} vkFreeMemory(device = address, memory = address, pAllocator = address)\n";
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1100
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
...
VK_LAYER_EXPORT VKAPI_ATTR void VKAPI_CALL vkUnmapMemory(VkDevice device, VkDeviceMemory memory)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkUnmapMemory(device = 0x" << nouppercase <<  hex << HandleCast(device) << dec << ", memory = 0x" << nouppercase <<  hex << HandleCast(memory) << dec << ")\n";
    }
    else {
        (*outputStream) << "t{" << getTIDIndex() << "} vkUnmapMemory(device = address, memory = address)\n";
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1100
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
...
VK_LAYER_EXPORT VKAPI_ATTR VkResult VKAPI_CALL vkFlushMappedMemoryRanges(VkDevice device, uint32_t memoryRangeCount, const VkMappedMemoryRange* pMemoryRanges)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkFlushMappedMemoryRanges(device = 0x" << nouppercase <<  hex << HandleCast(device) << dec << ", memoryRangeCount = 0x" << nouppercase <<  hex << memoryRangeCount << dec << ", pMemoryRanges = 0x" << nouppercase <<  hex << HandleCast(pMemoryRanges) << dec << ") = " << string_VkResult((VkResult)result) << endl;
    }
    else {
        (*outputStream) << "t{" << getTIDIndex() << "} vkFlushMappedMemoryRanges(device = address, memoryRangeCount = address, pMemoryRanges = address) = " << string_VkResult((VkResult)result) << endl;
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1100
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
...
VK_LAYER_EXPORT VKAPI_ATTR VkResult VKAPI_CALL vkInvalidateMappedMemoryRanges(VkDevice device, uint32_t memoryRangeCount, const VkMappedMemoryRange* pMemoryRanges)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkInvalidateMappedMemoryRanges(device = 0x" << nouppercase <<  hex << HandleCast(device) << dec << ", memoryRangeCount = 0x" << nouppercase <<  hex << memoryRangeCount << dec << ", pMemoryRanges = 0x" << nouppercase <<  hex << HandleCast(pMemoryRanges) << dec << ") = " << string_VkResult((VkResult)result) << endl;
    }
    else {
        (*outputStream) << "t{" << getTIDIndex() << "} vkInvalidateMappedMemoryRanges(device = address, memoryRangeCount = address, pMemoryRanges = address) = " << string_VkResult((VkResult)result) << endl;
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1100
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
...
VK_LAYER_EXPORT VKAPI_ATTR void VKAPI_CALL vkGetDeviceMemoryCommitment(VkDevice device, VkDeviceMemory memory, VkDeviceSize* pCommittedMemoryInBytes)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkGetDeviceMemoryCommitment(device = 0x" << nouppercase <<  hex << HandleCast(device) << dec << ", memory = 0x" << nouppercase <<  hex << HandleCast(memory) << dec << ", " << (pCommittedMemoryInBytes ? "*" : "") << "pCommittedMemoryInBytes = 0x" << nouppercase <<  hex << (pCommittedMemoryInBytes ? *pCommittedMemoryInBytes : 0) << dec << ")\n";
    }
    else {
        (*outputStream) << "t{" << getTIDIndex() << "} vkGetDeviceMemoryCommitment(device = address, memory = address, pCommittedMemoryInBytes = address)\n";
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1100
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
...
VK_LAYER_EXPORT VKAPI_ATTR VkResult VKAPI_CALL vkBindBufferMemory(VkDevice device, VkBuffer buffer, VkDeviceMemory memory, VkDeviceSize memoryOffset)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkBindBufferMemory(device = 0x" << nouppercase <<  hex << HandleCast(device) << dec << ", buffer = 0x" << nouppercase <<  hex << HandleCast(buffer) << dec << ", memory = 0x" << nouppercase <<  hex << HandleCast(memory) << dec << ", memoryOffset = 0x" << nouppercase <<  hex << memoryOffset << dec << ") = " << string_VkResult((VkResult)result) << endl;
    }
    else {
        (*outputStream) << "t{" << getTIDIndex() << "} vkBindBufferMemory(device = address, buffer = address, memory = address, memoryOffset = address) = " << string_VkResult((VkResult)result) << endl;
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1100
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
...
VK_LAYER_EXPORT VKAPI_ATTR VkResult VKAPI_CALL vkBindImageMemory(VkDevice device, VkImage image, VkDeviceMemory memory, VkDeviceSize memoryOffset)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkBindImageMemory(device = 0x" << nouppercase <<  hex << HandleCast(device) << dec << ", image = 0x" << nouppercase <<  hex << HandleCast(image) << dec << ", memory = 0x" << nouppercase <<  hex << HandleCast(memory) << dec << ", memoryOffset = 0x" << nouppercase <<  hex << memoryOffset << dec << ") = " << string_VkResult((VkResult)result) << endl;
    }
    else {
        (*outputStream) << "t{" << getTIDIndex() << "} vkBindImageMemory(device = address, image = address, memory = address, memoryOffset = address) = " << string_VkResult((VkResult)result) << endl;
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1100
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
...
VK_LAYER_EXPORT VKAPI_ATTR void VKAPI_CALL vkGetBufferMemoryRequirements(VkDevice device, VkBuffer buffer, VkMemoryRequirements* pMemoryRequirements)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkGetBufferMemoryRequirements(device = 0x" << nouppercase <<  hex << HandleCast(device) << dec << ", buffer = 0x" << nouppercase <<  hex << HandleCast(buffer) << dec << ", pMemoryRequirements = 0x" << nouppercase <<  hex << HandleCast(pMemoryRequirements) << dec << ")\n";
    }
    else {
        (*outputStream) << "t{" << getTIDIndex() << "} vkGetBufferMemoryRequirements(device = address, buffer = address, pMemoryRequirements = address)\n";
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1100
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
...
VK_LAYER_EXPORT VKAPI_ATTR void VKAPI_CALL vkGetImageMemoryRequirements(VkDevice device, VkImage image, VkMemoryRequirements* pMemoryRequirements)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkGetImageMemoryRequirements(device = 0x" << nouppercase <<  hex << HandleCast(device) << dec << ", image = 0x" << nouppercase <<  hex << HandleCast(image) << dec << ", pMemoryRequirements = 0x" << nouppercase <<  hex << HandleCast(pMemoryRequirements) << dec << ")\n";
    }
    else {
        (*outputStream) << "t{" << getTIDIndex() << "} vkGetImageMemoryRequirements(device = address, image = address, pMemoryRequirements = address)\n";
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1100
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
...
VK_LAYER_EXPORT VKAPI_ATTR void VKAPI_CALL vkGetImageSparseMemoryRequirements(VkDevice device, VkImage image, uint32_t* pSparseMemoryRequirementCount, VkSparseImageMemoryRequirements* pSparseMemoryRequirements)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkGetImageSparseMemoryRequirements(device = 0x" << nouppercase <<  hex << HandleCast(device) << dec << ", image = 0x" << nouppercase <<  hex << HandleCast(image) << dec << ", " << (pSparseMemoryRequirementCount ? "*" : "") << "pSparseMemoryRequirementCount = 0x" << nouppercase <<  hex << (pSparseMemoryRequirementCount ? *pSparseMemoryRequirementCount : 0) << dec << ", pSparseMemoryRequirements = 0x" << nouppercase <<  hex << HandleCast(pSparseMemoryRequirements) << dec << ")\n";
    }
    else {
        (*outputStream) << "t{" << getTIDIndex() << "} vkGetImageSparseMemoryRequirements(device = address, image = address, pSparseMemoryRequirementCount = address, pSparseMemoryRequirements = address)\n";
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1100
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
...
VK_LAYER_EXPORT VKAPI_ATTR void VKAPI_CALL vkGetPhysicalDeviceSparseImageFormatProperties(VkPhysicalDevice physicalDevice, VkFormat format, VkImageType type, VkSampleCountFlagBits samples, VkImageUsageFlags usage, VkImageTiling tiling, uint32_t* pPropertyCount, VkSparseImageFormatProperties* pProperties)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkGetPhysicalDeviceSparseImageFormatProperties(physicalDevice = 0x" << nouppercase <<  hex << HandleCast(physicalDevice) << dec << ", format = " << string_VkFormat(format) << ", type = " << string_VkImageType(type) << ", samples = " << string_VkSampleCountFlagBits(samples) << ", usage = 0x" << nouppercase <<  hex << usage << dec << ", tiling = " << string_VkImageTiling(tiling) << ", " << (pPropertyCount ? "*" : "") << "pPropertyCount = 0x" << nouppercase <<  hex << (pPropertyCount ? *pPropertyCount : 0) << dec << ", pProperties = 0x" << nouppercase <<  hex << HandleCast(pProperties) << dec << ")\n";
    }
    else {
        (*outputStream) << "t{" << getTIDIndex() << "} vkGetPhysicalDeviceSparseImageFormatProperties(physicalDevice = address, format = " << string_VkFormat(format) << ", type = " << string_VkImageType(type) << ", samples = " << string_VkSampleCountFlagBits(samples) << ", usage = address, tiling = " << string_VkImageTiling(tiling) << ", pPropertyCount = address, pProperties = address)\n";
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1100
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
...
VK_LAYER_EXPORT VKAPI_ATTR VkResult VKAPI_CALL vkQueueBindSparse(VkQueue queue, uint32_t bindInfoCount, const VkBindSparseInfo* pBindInfo, VkFence fence)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkQueueBindSparse(queue = 0x" << nouppercase <<  hex << HandleCast(queue) << dec << ", bindInfoCount = 0x" << nouppercase <<  hex << bindInfoCount << dec << ", pBindInfo = 0x" << nouppercase <<  hex << HandleCast(pBindInfo) << dec << ", fence = 0x" << nouppercase <<  hex << HandleCast(fence) << dec << ") = " << string_VkResult((VkResult)result) << endl;
    }
    else {
        (*outputStream) << "t{" << getTIDIndex() << "} vkQueueBindSparse(queue = address, bindInfoCount = address, pBindInfo = address, fence = address) = " << string_VkResult((VkResult)result) << endl;
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1100
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
...
VK_LAYER_EXPORT VKAPI_ATTR VkResult VKAPI_CALL vkCreateFence(VkDevice device, const VkFenceCreateInfo* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkFence* pFence)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkCreateFence(device = 0x" << nouppercase <<  hex << HandleCast(device) << dec << ", pCreateInfo = 0x" << nouppercase <<  hex << HandleCast(pCreateInfo) << dec << ", pAllocator = 0x" << nouppercase <<  hex << HandleCast(pAllocator) << dec << ", " << (pFence ? "*" : "") << "pFence = 0x" << nouppercase <<  hex << (pFence ? HandleCast(*pFence) : 0) << dec << ") = " << string_VkResult((VkResult)result) << endl;
    }
    else {
        (*outputStream) << "t{" << getTIDIndex() << "} vkCreateFence(device = address, pCreateInfo = address, pAllocator = address, pFence = address) = " << string_VkResult((VkResult)result) << endl;
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1100
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
...
VK_LAYER_EXPORT VKAPI_ATTR void VKAPI_CALL vkDestroyFence(VkDevice device, VkFence fence, const VkAllocationCallbacks* pAllocator)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkDestroyFence(device = 0x" << nouppercase <<  hex << HandleCast(device) << dec << ", fence = 0x" << nouppercase <<  hex << HandleCast(fence) << dec << ", pAllocator = 0x" << nouppercase <<  hex << HandleCast(pAllocator) << dec << ")\n";
    }
    else {
        (*outputStream) << "t{" << getTIDIndex() << "} vkDestroyFence(device = address, fence = address, pAllocator = address)\n";
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1100
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
...
VK_LAYER_EXPORT VKAPI_ATTR VkResult VKAPI_CALL vkResetFences(VkDevice device, uint32_t fenceCount, const VkFence* pFences)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkResetFences(device = 0x" << nouppercase <<  hex << HandleCast(device) << dec << ", fenceCount = 0x" << nouppercase <<  hex << fenceCount << dec << ", " << (pFences ? "*" : "") << "pFences = 0x" << nouppercase <<  hex << (pFences ? HandleCast(*pFences) : 0) << dec << ") = " << string_VkResult((VkResult)result) << endl;
    }
    else {
        (*outputStream) << "t{" << getTIDIndex() << "} vkResetFences(device = address, fenceCount = address, pFences = address) = " << string_VkResult((VkResult)result) << endl;
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1100
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
...
VK_LAYER_EXPORT VKAPI_ATTR VkResult VKAPI_CALL vkGetFenceStatus(VkDevice device, VkFence fence)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkGetFenceStatus(device = 0x" << nouppercase <<  hex << HandleCast(device) << dec << ", fence = 0x" << nouppercase <<  hex << HandleCast(fence) << dec << ") = " << string_VkResult((VkResult)result) << endl;
    }
    else {
        (*outputStream) << "t{" << getTIDIndex() << "} vkGetFenceStatus(device = address, fence = address) = " << string_VkResult((VkResult)result) << endl;
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1100
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
...
VK_LAYER_EXPORT VKAPI_ATTR VkResult VKAPI_CALL vkWaitForFences(VkDevice device, uint32_t fenceCount, const VkFence* pFences, VkBool32 waitAll, uint64_t timeout)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkWaitForFences(device = 0x" << nouppercase <<  hex << HandleCast(device) << dec << ", fenceCount = 0x" << nouppercase <<  hex << fenceCount << dec << ", " << (pFences ? "*" : "") << "pFences = 0x" << nouppercase <<  hex << (pFences ? HandleCast(*pFences) : 0) << dec << ", waitAll = " << waitAll << ", timeout = 0x" << nouppercase <<  hex << timeout << dec << ") = " << string_VkResult((VkResult)result) << endl;
    }
    else {
        (*outputStream) << "t{" << getTIDIndex() << "} vkWaitForFences(device = address, fenceCount = address, pFences = address, waitAll = " << waitAll << ", timeout = address) = " << string_VkResult((VkResult)result) << endl;
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1100
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
...
VK_LAYER_EXPORT VKAPI_ATTR VkResult VKAPI_CALL vkCreateSemaphore(VkDevice device, const VkSemaphoreCreateInfo* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkSemaphore* pSemaphore)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkCreateSemaphore(device = 0x" << nouppercase <<  hex << HandleCast(device) << dec << ", pCreateInfo = 0x" << nouppercase <<  hex << HandleCast(pCreateInfo) << dec << ", pAllocator = 0x" << nouppercase <<  hex << HandleCast(pAllocator) << dec << ", " << (pSemaphore ? "*" : "") << "pSemaphore = 0x" << nouppercase <<  hex << (pSemaphore ? HandleCast(*pSemaphore) : 0) << dec << ") = " << string_VkResult((VkResult)result) << endl;
    }
    else {
        (*outputStream) << "t{" << getTIDIndex() << "} vkCreateSemaphore(device = address, pCreateInfo = address, pAllocator = address, pSemaphore = address) = " << string_VkResult((VkResult)result) << endl;
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1100
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
...
VK_LAYER_EXPORT VKAPI_ATTR void VKAPI_CALL vkDestroySemaphore(VkDevice device, VkSemaphore semaphore, const VkAllocationCallbacks* pAllocator)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkDestroySemaphore(device = 0x" << nouppercase <<  hex << HandleCast(device) << dec << ", semaphore = 0x" << nouppercase <<  hex << HandleCast(semaphore) << dec << ", pAllocator = 0x" << nouppercase <<  hex << HandleCast(pAllocator) << dec << ")\n";
    }
    else {
        (*outputStream) << "t{" << getTIDIndex() << "} vkDestroySemaphore(device = address, semaphore = address, pAllocator = address)\n";
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1100
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
...
VK_LAYER_EXPORT VKAPI_ATTR VkResult VKAPI_CALL vkCreateEvent(VkDevice device, const VkEventCreateInfo* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkEvent* pEvent)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkCreateEvent(device = 0x" << nouppercase <<  hex << HandleCast(device) << dec << ", pCreateInfo = 0x" << nouppercase <<  hex << HandleCast(pCreateInfo) << dec << ", pAllocator = 0x" << nouppercase <<  hex << HandleCast(pAllocator) << dec << ", " << (pEvent ? "*" : "") << "pEvent = 0x" << nouppercase <<  hex << (pEvent ? HandleCast(*pEvent) : 0) << dec << ") = " << string_VkResult((VkResult)result) << endl;
    }
    else {
        (*outputStream) << "t{" << getTIDIndex() << "} vkCreateEvent(device = address, pCreateInfo = address, pAllocator = address, pEvent = address) = " << string_VkResult((VkResult)result) << endl;
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1100
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
...
VK_LAYER_EXPORT VKAPI_ATTR void VKAPI_CALL vkDestroyEvent(VkDevice device, VkEvent event, const VkAllocationCallbacks* pAllocator)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkDestroyEvent(device = 0x" << nouppercase <<  hex << HandleCast(device) << dec << ", event = 0x" << nouppercase <<  hex << HandleCast(event) << dec << ", pAllocator = 0x" << nouppercase <<  hex << HandleCast(pAllocator) << dec << ")\n";
    }
    else {
        (*outputStream) << "t{" << getTIDIndex() << "} vkDestroyEvent(device = address, event = address, pAllocator = address)\n";
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1100
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
...
VK_LAYER_EXPORT VKAPI_ATTR VkResult VKAPI_CALL vkGetEventStatus(VkDevice device, VkEvent event)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkGetEventStatus(device = 0x" << nouppercase <<  hex << HandleCast(device) << dec << ", event = 0x" << nouppercase <<  hex << HandleCast(event) << dec << ") = " << string_VkResult((VkResult)result) << endl;
    }
    else {
        (*outputStream) << "t{" << getTIDIndex() << "} vkGetEventStatus(device = address, event = address) = " << string_VkResult((VkResult)result) << endl;
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1100
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
...
VK_LAYER_EXPORT VKAPI_ATTR VkResult VKAPI_CALL vkSetEvent(VkDevice device, VkEvent event)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkSetEvent(device = 0x" << nouppercase <<  hex << HandleCast(device) << dec << ", event = 0x" << nouppercase <<  hex << HandleCast(event) << dec << ") = " << string_VkResult((VkResult)result) << endl;
    }
    else {
        (*outputStream) << "t{" << getTIDIndex() << "} vkSetEvent(device = address, event = address) = " << string_VkResult((VkResult)result) << endl;
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1100
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
...
VK_LAYER_EXPORT VKAPI_ATTR VkResult VKAPI_CALL vkResetEvent(VkDevice device, VkEvent event)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkResetEvent(device = 0x" << nouppercase <<  hex << HandleCast(device) << dec << ", event = 0x" << nouppercase <<  hex << HandleCast(event) << dec << ") = " << string_VkResult((VkResult)result) << endl;
    }
    else {
        (*outputStream) << "t{" << getTIDIndex() << "} vkResetEvent(device = address, event = address) = " << string_VkResult((VkResult)result) << endl;
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1100
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
...
VK_LAYER_EXPORT VKAPI_ATTR VkResult VKAPI_CALL vkCreateQueryPool(VkDevice device, const VkQueryPoolCreateInfo* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkQueryPool* pQueryPool)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkCreateQueryPool(device = 0x" << nouppercase <<  hex << HandleCast(device) << dec << ", pCreateInfo = 0x" << nouppercase <<  hex << HandleCast(pCreateInfo) << dec << ", pAllocator = 0x" << nouppercase <<  hex << HandleCast(pAllocator) << dec << ", " << (pQueryPool ? "*" : "") << "pQueryPool = 0x" << nouppercase <<  hex << (pQueryPool ? HandleCast(*pQueryPool) : 0) << dec << ") = " << string_VkResult((VkResult)result) << endl;
    }
    else {
        (*outputStream) << "t{" << getTIDIndex() << "} vkCreateQueryPool(device = address, pCreateInfo = address, pAllocator = address, pQueryPool = address) = " << string_VkResult((VkResult)result) << endl;
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1100
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
...
VK_LAYER_EXPORT VKAPI_ATTR void VKAPI_CALL vkDestroyQueryPool(VkDevice device, VkQueryPool queryPool, const VkAllocationCallbacks* pAllocator)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkDestroyQueryPool(device = 0x" << nouppercase <<  hex << HandleCast(device) << dec << ", queryPool = 0x" << nouppercase <<  hex << HandleCast(queryPool) << dec << ", pAllocator = 0x" << nouppercase <<  hex << HandleCast(pAllocator) << dec << ")\n";
    }
    else {
        (*outputStream) << "t{" << getTIDIndex() << "} vkDestroyQueryPool(device = address, queryPool = address, pAllocator = address)\n";
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1100
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
...
VK_LAYER_EXPORT VKAPI_ATTR VkResult VKAPI_CALL vkCreateBuffer(VkDevice device, const VkBufferCreateInfo* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkBuffer* pBuffer)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkCreateBuffer(device = 0x" << nouppercase <<  hex << HandleCast(device) << dec << ", pCreateInfo = 0x" << nouppercase <<  hex << HandleCast(pCreateInfo) << dec << ", pAllocator = 0x" << nouppercase <<  hex << HandleCast(pAllocator) << dec << ", " << (pBuffer ? "*" : "") << "pBuffer = 0x" << nouppercase <<  hex << (pBuffer ? HandleCast(*pBuffer) : 0) << dec << ") = " << string_VkResult((VkResult)result) << endl;
    }
    else {
        (*outputStream) << "t{" << getTIDIndex() << "} vkCreateBuffer(device = address, pCreateInfo = address, pAllocator = address, pBuffer = address) = " << string_VkResult((VkResult)result) << endl;
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1100
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
...
VK_LAYER_EXPORT VKAPI_ATTR void VKAPI_CALL vkDestroyBuffer(VkDevice device, VkBuffer buffer, const VkAllocationCallbacks* pAllocator)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkDestroyBuffer(device = 0x" << nouppercase <<  hex << HandleCast(device) << dec << ", buffer = 0x" << nouppercase <<  hex << HandleCast(buffer) << dec << ", pAllocator = 0x" << nouppercase <<  hex << HandleCast(pAllocator) << dec << ")\n";
    }
    else {
        (*outputStream) << "t{" << getTIDIndex() << "} vkDestroyBuffer(device = address, buffer = address, pAllocator = address)\n";
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1100
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
...
VK_LAYER_EXPORT VKAPI_ATTR VkResult VKAPI_CALL vkCreateBufferView(VkDevice device, const VkBufferViewCreateInfo* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkBufferView* pView)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkCreateBufferView(device = 0x" << nouppercase <<  hex << HandleCast(device) << dec << ", pCreateInfo = 0x" << nouppercase <<  hex << HandleCast(pCreateInfo) << dec << ", pAllocator = 0x" << nouppercase <<  hex << HandleCast(pAllocator) << dec << ", " << (pView ? "*" : "") << "pView = 0x" << nouppercase <<  hex << (pView ? HandleCast(*pView) : 0) << dec << ") = " << string_VkResult((VkResult)result) << endl;
    }
    else {
        (*outputStream) << "t{" << getTIDIndex() << "} vkCreateBufferView(device = address, pCreateInfo = address, pAllocator = address, pView = address) = " << string_VkResult((VkResult)result) << endl;
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1100
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
...
VK_LAYER_EXPORT VKAPI_ATTR void VKAPI_CALL vkDestroyBufferView(VkDevice device, VkBufferView bufferView, const VkAllocationCallbacks* pAllocator)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkDestroyBufferView(device = 0x" << nouppercase <<  hex << HandleCast(device) << dec << ", bufferView = 0x" << nouppercase <<  hex << HandleCast(bufferView) << dec << ", pAllocator = 0x" << nouppercase <<  hex << HandleCast(pAllocator) << dec << ")\n";
    }
    else {
        (*outputStream) << "t{" << getTIDIndex() << "} vkDestroyBufferView(device = address, bufferView = address, pAllocator = address)\n";
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1100
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
...
VK_LAYER_EXPORT VKAPI_ATTR VkResult VKAPI_CALL vkCreateImage(VkDevice device, const VkImageCreateInfo* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkImage* pImage)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkCreateImage(device = 0x" << nouppercase <<  hex << HandleCast(device) << dec << ", pCreateInfo = 0x" << nouppercase <<  hex << HandleCast(pCreateInfo) << dec << ", pAllocator = 0x" << nouppercase <<  hex << HandleCast(pAllocator) << dec << ", " << (pImage ? "*" : "") << "pImage = 0x" << nouppercase <<  hex << (pImage ? HandleCast(*pImage) : 0) << dec << ") = " << string_VkResult((VkResult)result) << endl;
    }
    else {
        (*outputStream) << "t{" << getTIDIndex() << "} vkCreateImage(device = address, pCreateInfo = address, pAllocator = address, pImage = address) = " << string_VkResult((VkResult)result) << endl;
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1100
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
...
VK_LAYER_EXPORT VKAPI_ATTR void VKAPI_CALL vkDestroyImage(VkDevice device, VkImage image, const VkAllocationCallbacks* pAllocator)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkDestroyImage(device = 0x" << nouppercase <<  hex << HandleCast(device) << dec << ", image = 0x" << nouppercase <<  hex << HandleCast(image) << dec << ", pAllocator = 0x" << nouppercase <<  hex << HandleCast(pAllocator) << dec << ")\n";
    }
    else {
        (*outputStream) << "t{" << getTIDIndex() << "} vkDestroyImage(device = address, image = address, pAllocator = address)\n";
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1100
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
...
VK_LAYER_EXPORT VKAPI_ATTR void VKAPI_CALL vkGetImageSubresourceLayout(VkDevice device, VkImage image, const VkImageSubresource* pSubresource, VkSubresourceLayout* pLayout)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkGetImageSubresourceLayout(device = 0x" << nouppercase <<  hex << HandleCast(device) << dec << ", image = 0x" << nouppercase <<  hex << HandleCast(image) << dec << ", pSubresource = 0x" << nouppercase <<  hex << HandleCast(pSubresource) << dec << ", pLayout = 0x" << nouppercase <<  hex << HandleCast(pLayout) << dec << ")\n";
    }
    else {
        (*outputStream) << "t{" << getTIDIndex() << "} vkGetImageSubresourceLayout(device = address, image = address, pSubresource = address, pLayout = address)\n";
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1100
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
...
VK_LAYER_EXPORT VKAPI_ATTR VkResult VKAPI_CALL vkCreateImageView(VkDevice device, const VkImageViewCreateInfo* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkImageView* pView)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkCreateImageView(device = 0x" << nouppercase <<  hex << HandleCast(device) << dec << ", pCreateInfo = 0x" << nouppercase <<  hex << HandleCast(pCreateInfo) << dec << ", pAllocator = 0x" << nouppercase <<  hex << HandleCast(pAllocator) << dec << ", " << (pView ? "*" : "") << "pView = 0x" << nouppercase <<  hex << (pView ? HandleCast(*pView) : 0) << dec << ") = " << string_VkResult((VkResult)result) << endl;
    }
    else {
        (*outputStream) << "t{" << getTIDIndex() << "} vkCreateImageView(device = address, pCreateInfo = address, pAllocator = address, pView = address) = " << string_VkResult((VkResult)result) << endl;
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1100
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
...
VK_LAYER_EXPORT VKAPI_ATTR void VKAPI_CALL vkDestroyImageView(VkDevice device, VkImageView imageView, const VkAllocationCallbacks* pAllocator)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkDestroyImageView(device = 0x" << nouppercase <<  hex << HandleCast(device) << dec << ", imageView = 0x" << nouppercase <<  hex << HandleCast(imageView) << dec << ", pAllocator = 0x" << nouppercase <<  hex << HandleCast(pAllocator) << dec << ")\n";
    }
    else {
        (*outputStream) << "t{" << getTIDIndex() << "} vkDestroyImageView(device = address, imageView = address, pAllocator = address)\n";
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1100
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
...
VK_LAYER_EXPORT VKAPI_ATTR void VKAPI_CALL vkDestroyShaderModule(VkDevice device, VkShaderModule shaderModule, const VkAllocationCallbacks* pAllocator)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkDestroyShaderModule(device = 0x" << nouppercase <<  hex << HandleCast(device) << dec << ", shaderModule = 0x" << nouppercase <<  hex << HandleCast(shaderModule) << dec << ", pAllocator = 0x" << nouppercase <<  hex << HandleCast(pAllocator) << dec << ")\n";
    }
    else {
        (*outputStream) << "t{" << getTIDIndex() << "} vkDestroyShaderModule(device = address, shaderModule = address, pAllocator = address)\n";
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1100
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
...
VK_LAYER_EXPORT VKAPI_ATTR VkResult VKAPI_CALL vkCreatePipelineCache(VkDevice device, const VkPipelineCacheCreateInfo* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkPipelineCache* pPipelineCache)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkCreatePipelineCache(device = 0x" << nouppercase <<  hex << HandleCast(device) << dec << ", pCreateInfo = 0x" << nouppercase <<  hex << HandleCast(pCreateInfo) << dec << ", pAllocator = 0x" << nouppercase <<  hex << HandleCast(pAllocator) << dec << ", " << (pPipelineCache ? "*" : "") << "pPipelineCache = 0x" << nouppercase <<  hex << (pPipelineCache ? HandleCast(*pPipelineCache) : 0) << dec << ") = " << string_VkResult((VkResult)result) << endl;
    }
    else {
        (*outputStream) << "t{" << getTIDIndex() << "} vkCreatePipelineCache(device = address, pCreateInfo = address, pAllocator = address, pPipelineCache = address) = " << string_VkResult((VkResult)result) << endl;
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1100
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
...
VK_LAYER_EXPORT VKAPI_ATTR void VKAPI_CALL vkDestroyPipelineCache(VkDevice device, VkPipelineCache pipelineCache, const VkAllocationCallbacks* pAllocator)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkDestroyPipelineCache(device = 0x" << nouppercase <<  hex << HandleCast(device) << dec << ", pipelineCache = 0x" << nouppercase <<  hex << HandleCast(pipelineCache) << dec << ", pAllocator = 0x" << nouppercase <<  hex << HandleCast(pAllocator) << dec << ")\n";
    }
    else {
        (*outputStream) << "t{" << getTIDIndex() << "} vkDestroyPipelineCache(device = address, pipelineCache = address, pAllocator = address)\n";
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1100
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
...
VK_LAYER_EXPORT VKAPI_ATTR VkResult VKAPI_CALL vkGetPipelineCacheData(VkDevice device, VkPipelineCache pipelineCache, size_t* pDataSize, void* pData)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkGetPipelineCacheData(device = 0x" << nouppercase <<  hex << HandleCast(device) << dec << ", pipelineCache = 0x" << nouppercase <<  hex << HandleCast(pipelineCache) << dec << ", " << (pDataSize ? "*" : "") << "pDataSize = 0x" << nouppercase <<  hex << (pDataSize ? *pDataSize : 0) << dec << ", pData = 0x" << nouppercase <<  hex << HandleCast(pData) << dec << ") = " << string_VkResult((VkResult)result) << endl;
    }
    else {
        (*outputStream) << "t{" << getTIDIndex() << "} vkGetPipelineCacheData(device = address, pipelineCache = address, pDataSize = address, pData = address) = " << string_VkResult((VkResult)result) << endl;
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1100
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
...
VK_LAYER_EXPORT VKAPI_ATTR VkResult VKAPI_CALL vkMergePipelineCaches(VkDevice device, VkPipelineCache dstCache, uint32_t srcCacheCount, const VkPipelineCache* pSrcCaches)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkMergePipelineCaches(device = 0x" << nouppercase <<  hex << HandleCast(device) << dec << ", dstCache = 0x" << nouppercase <<  hex << HandleCast(dstCache) << dec << ", srcCacheCount = 0x" << nouppercase <<  hex << srcCacheCount << dec << ", " << (pSrcCaches ? "*" : "") << "pSrcCaches = 0x" << nouppercase <<  hex << (pSrcCaches ? HandleCast(*pSrcCaches) : 0) << dec << ") = " << string_VkResult((VkResult)result) << endl;
    }
    else {
        (*outputStream) << "t{" << getTIDIndex() << "} vkMergePipelineCaches(device = address, dstCache = address, srcCacheCount = address, pSrcCaches = address) = " << string_VkResult((VkResult)result) << endl;
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1100
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
...
VK_LAYER_EXPORT VKAPI_ATTR VkResult VKAPI_CALL vkCreateGraphicsPipelines(VkDevice device, VkPipelineCache pipelineCache, uint32_t createInfoCount, const VkGraphicsPipelineCreateInfo* pCreateInfos, const VkAllocationCallbacks* pAllocator, VkPipeline* pPipelines)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkCreateGraphicsPipelines(device = 0x" << nouppercase <<  hex << HandleCast(device) << dec << ", pipelineCache = 0x" << nouppercase <<  hex << HandleCast(pipelineCache) << dec << ", createInfoCount = 0x" << nouppercase <<  hex << createInfoCount << dec << ", pCreateInfos = 0x" << nouppercase <<  hex << HandleCast(pCreateInfos) << dec << ", pAllocator = 0x" << nouppercase <<  hex << HandleCast(pAllocator) << dec << ", " << (pPipelines ? "*" : "") << "pPipelines = 0x" << nouppercase <<  hex << (pPipelines ? HandleCast(*pPipelines) : 0) << dec << ") = " << string_VkResult((VkResult)result) << endl;
    }
    else {
        (*outputStream) << "t{" << getTIDIndex() << "} vkCreateGraphicsPipelines(device = address, pipelineCache = address, createInfoCount = address, pCreateInfos = address, pAllocator = address, pPipelines = address) = " << string_VkResult((VkResult)result) << endl;
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1100
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
...
VK_LAYER_EXPORT VKAPI_ATTR VkResult VKAPI_CALL vkCreateComputePipelines(VkDevice device, VkPipelineCache pipelineCache, uint32_t createInfoCount, const VkComputePipelineCreateInfo* pCreateInfos, const VkAllocationCallbacks* pAllocator, VkPipeline* pPipelines)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkCreateComputePipelines(device = 0x" << nouppercase <<  hex << HandleCast(device) << dec << ", pipelineCache = 0x" << nouppercase <<  hex << HandleCast(pipelineCache) << dec << ", createInfoCount = 0x" << nouppercase <<  hex << createInfoCount << dec << ", pCreateInfos = 0x" << nouppercase <<  hex << HandleCast(pCreateInfos) << dec << ", pAllocator = 0x" << nouppercase <<  hex << HandleCast(pAllocator) << dec << ", " << (pPipelines ? "*" : "") << "pPipelines = 0x" << nouppercase <<  hex << (pPipelines ? HandleCast(*pPipelines) : 0) << dec << ") = " << string_VkResult((VkResult)result) << endl;
    }
    else {
        (*outputStream) << "t{" << getTIDIndex() << "} vkCreateComputePipelines(device = address, pipelineCache = address, createInfoCount = address, pCreateInfos = address, pAllocator = address, pPipelines = address) = " << string_VkResult((VkResult)result) << endl;
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1100
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
...
VK_LAYER_EXPORT VKAPI_ATTR void VKAPI_CALL vkDestroyPipeline(VkDevice device, VkPipeline pipeline, const VkAllocationCallbacks* pAllocator)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkDestroyPipeline(device = 0x" << nouppercase <<  hex << HandleCast(device) << dec << ", pipeline = 0x" << nouppercase <<  hex << HandleCast(pipeline) << dec << ", pAllocator = 0x" << nouppercase <<  hex << HandleCast(pAllocator) << dec << ")\n";
    }
    else {
        (*outputStream) << "t{" << getTIDIndex() << "} vkDestroyPipeline(device = address, pipeline = address, pAllocator = address)\n";
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1100
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
...
VK_LAYER_EXPORT VKAPI_ATTR VkResult VKAPI_CALL vkCreatePipelineLayout(VkDevice device, const VkPipelineLayoutCreateInfo* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkPipelineLayout* pPipelineLayout)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkCreatePipelineLayout(device = 0x" << nouppercase <<  hex << HandleCast(device) << dec << ", pCreateInfo = 0x" << nouppercase <<  hex << HandleCast(pCreateInfo) << dec << ", pAllocator = 0x" << nouppercase <<  hex << HandleCast(pAllocator) << dec << ", " << (pPipelineLayout ? "*" : "") << "pPipelineLayout = 0x" << nouppercase <<  hex << (pPipelineLayout ? HandleCast(*pPipelineLayout) : 0) << dec << ") = " << string_VkResult((VkResult)result) << endl;
    }
    else {
        (*outputStream) << "t{" << getTIDIndex() << "} vkCreatePipelineLayout(device = address, pCreateInfo = address, pAllocator = address, pPipelineLayout = address) = " << string_VkResult((VkResult)result) << endl;
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1100
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
...
VK_LAYER_EXPORT VKAPI_ATTR void VKAPI_CALL vkDestroyPipelineLayout(VkDevice device, VkPipelineLayout pipelineLayout, const VkAllocationCallbacks* pAllocator)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkDestroyPipelineLayout(device = 0x" << nouppercase <<  hex << HandleCast(device) << dec << ", pipelineLayout = 0x" << nouppercase <<  hex << HandleCast(pipelineLayout) << dec << ", pAllocator = 0x" << nouppercase <<  hex << HandleCast(pAllocator) << dec << ")\n";
    }
    else {
        (*outputStream) << "t{" << getTIDIndex() << "} vkDestroyPipelineLayout(device = address, pipelineLayout = address, pAllocator = address)\n";
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1100
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
...
VK_LAYER_EXPORT VKAPI_ATTR VkResult VKAPI_CALL vkCreateSampler(VkDevice device, const VkSamplerCreateInfo* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkSampler* pSampler)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkCreateSampler(device = 0x" << nouppercase <<  hex << HandleCast(device) << dec << ", pCreateInfo = 0x" << nouppercase <<  hex << HandleCast(pCreateInfo) << dec << ", pAllocator = 0x" << nouppercase <<  hex << HandleCast(pAllocator) << dec << ", " << (pSampler ? "*" : "") << "pSampler = 0x" << nouppercase <<  hex << (pSampler ? HandleCast(*pSampler) : 0) << dec << ") = " << string_VkResult((VkResult)result) << endl;
    }
    else {
        (*outputStream) << "t{" << getTIDIndex() << "} vkCreateSampler(device = address, pCreateInfo = address, pAllocator = address, pSampler = address) = " << string_VkResult((VkResult)result) << endl;
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1100
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
...
VK_LAYER_EXPORT VKAPI_ATTR void VKAPI_CALL vkDestroySampler(VkDevice device, VkSampler sampler, const VkAllocationCallbacks* pAllocator)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkDestroySampler(device = 0x" << nouppercase <<  hex << HandleCast(device) << dec << ", sampler = 0x" << nouppercase <<  hex << HandleCast(sampler) << dec << ", pAllocator = 0x" << nouppercase <<  hex << HandleCast(pAllocator) << dec << ")\n";
    }
    else {
        (*outputStream) << "t{" << getTIDIndex() << "} vkDestroySampler(device = address, sampler = address, pAllocator = address)\n";
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1100
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
...
VK_LAYER_EXPORT VKAPI_ATTR VkResult VKAPI_CALL vkCreateDescriptorSetLayout(VkDevice device, const VkDescriptorSetLayoutCreateInfo* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkDescriptorSetLayout* pSetLayout)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkCreateDescriptorSetLayout(device = 0x" << nouppercase <<  hex << HandleCast(device) << dec << ", pCreateInfo = 0x" << nouppercase <<  hex << HandleCast(pCreateInfo) << dec << ", pAllocator = 0x" << nouppercase <<  hex << HandleCast(pAllocator) << dec << ", " << (pSetLayout ? "*" : "") << "pSetLayout = 0x" << nouppercase <<  hex << (pSetLayout ? HandleCast(*pSetLayout) : 0) << dec << ") = " << string_VkResult((VkResult)result) << endl;
    }
    else {
        (*outputStream) << "t{" << getTIDIndex() << "} vkCreateDescriptorSetLayout(device = address, pCreateInfo = address, pAllocator = address, pSetLayout = address) = " << string_VkResult((VkResult)result) << endl;
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1100
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
...
VK_LAYER_EXPORT VKAPI_ATTR void VKAPI_CALL vkDestroyDescriptorSetLayout(VkDevice device, VkDescriptorSetLayout descriptorSetLayout, const VkAllocationCallbacks* pAllocator)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkDestroyDescriptorSetLayout(device = 0x" << nouppercase <<  hex << HandleCast(device) << dec << ", descriptorSetLayout = 0x" << nouppercase <<  hex << HandleCast(descriptorSetLayout) << dec << ", pAllocator = 0x" << nouppercase <<  hex << HandleCast(pAllocator) << dec << ")\n";
    }
    else {
        (*outputStream) << "t{" << getTIDIndex() << "} vkDestroyDescriptorSetLayout(device = address, descriptorSetLayout = address, pAllocator = address)\n";
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1100
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
...
VK_LAYER_EXPORT VKAPI_ATTR void VKAPI_CALL vkDestroyDescriptorPool(VkDevice device, VkDescriptorPool descriptorPool, const VkAllocationCallbacks* pAllocator)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkDestroyDescriptorPool(device = 0x" << nouppercase <<  hex << HandleCast(device) << dec << ", descriptorPool = 0x" << nouppercase <<  hex << HandleCast(descriptorPool) << dec << ", pAllocator = 0x" << nouppercase <<  hex << HandleCast(pAllocator) << dec << ")\n";
    }
    else {
        (*outputStream) << "t{" << getTIDIndex() << "} vkDestroyDescriptorPool(device = address, descriptorPool = address, pAllocator = address)\n";
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1100
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
...
VK_LAYER_EXPORT VKAPI_ATTR VkResult VKAPI_CALL vkResetDescriptorPool(VkDevice device, VkDescriptorPool descriptorPool, VkDescriptorPoolResetFlags flags)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkResetDescriptorPool(device = 0x" << nouppercase <<  hex << HandleCast(device) << dec << ", descriptorPool = 0x" << nouppercase <<  hex << HandleCast(descriptorPool) << dec << ", flags = 0x" << nouppercase <<  hex << flags << dec << ") = " << string_VkResult((VkResult)result) << endl;
    }
    else {
        (*outputStream) << "t{" << getTIDIndex() << "} vkResetDescriptorPool(device = address, descriptorPool = address, flags = address) = " << string_VkResult((VkResult)result) << endl;
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1100
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
...
VK_LAYER_EXPORT VKAPI_ATTR VkResult VKAPI_CALL vkAllocateDescriptorSets(VkDevice device, const VkDescriptorSetAllocateInfo* pAllocateInfo, VkDescriptorSet* pDescriptorSets)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkAllocateDescriptorSets(device = 0x" << nouppercase <<  hex << HandleCast(device) << dec << ", pAllocateInfo = 0x" << nouppercase <<  hex << HandleCast(pAllocateInfo) << dec << ", " << (pDescriptorSets ? "*" : "") << "pDescriptorSets = 0x" << nouppercase <<  hex << (pDescriptorSets ? HandleCast(*pDescriptorSets) : 0) << dec << ") = " << string_VkResult((VkResult)result) << endl;
    }
    else {
        (*outputStream) << "t{" << getTIDIndex() << "} vkAllocateDescriptorSets(device = address, pAllocateInfo = address, pDescriptorSets = address) = " << string_VkResult((VkResult)result) << endl;
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1100
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
...
VK_LAYER_EXPORT VKAPI_ATTR VkResult VKAPI_CALL vkFreeDescriptorSets(VkDevice device, VkDescriptorPool descriptorPool, uint32_t descriptorSetCount, const VkDescriptorSet* pDescriptorSets)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkFreeDescriptorSets(device = 0x" << nouppercase <<  hex << HandleCast(device) << dec << ", descriptorPool = 0x" << nouppercase <<  hex << HandleCast(descriptorPool) << dec << ", descriptorSetCount = 0x" << nouppercase <<  hex << descriptorSetCount << dec << ", " << (pDescriptorSets ? "*" : "") << "pDescriptorSets = 0x" << nouppercase <<  hex << (pDescriptorSets ? HandleCast(*pDescriptorSets) : 0) << dec << ") = " << string_VkResult((VkResult)result) << endl;
    }
    else {
        (*outputStream) << "t{" << getTIDIndex() << "} vkFreeDescriptorSets(device = address, descriptorPool = address, descriptorSetCount = address, pDescriptorSets = address) = " << string_VkResult((VkResult)result) << endl;
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1100
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
...
VK_LAYER_EXPORT VKAPI_ATTR void VKAPI_CALL vkUpdateDescriptorSets(VkDevice device, uint32_t descriptorWriteCount, const VkWriteDescriptorSet* pDescriptorWrites, uint32_t descriptorCopyCount, const VkCopyDescriptorSet* pDescriptorCopies)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkUpdateDescriptorSets(device = 0x" << nouppercase <<  hex << HandleCast(device) << dec << ", descriptorWriteCount = 0x" << nouppercase <<  hex << descriptorWriteCount << dec << ", pDescriptorWrites = 0x" << nouppercase <<  hex << HandleCast(pDescriptorWrites) << dec << ", descriptorCopyCount = 0x" << nouppercase <<  hex << descriptorCopyCount << dec << ", pDescriptorCopies = 0x" << nouppercase <<  hex << HandleCast(pDescriptorCopies) << dec << ")\n";
    }
    else {
        (*outputStream) << "t{" << getTIDIndex() << "} vkUpdateDescriptorSets(device = address, descriptorWriteCount = address, pDescriptorWrites = address, descriptorCopyCount = address, pDescriptorCopies = address)\n";
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1100
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
...
VK_LAYER_EXPORT VKAPI_ATTR VkResult VKAPI_CALL vkCreateFramebuffer(VkDevice device, const VkFramebufferCreateInfo* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkFramebuffer* pFramebuffer)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkCreateFramebuffer(device = 0x" << nouppercase <<  hex << HandleCast(device) << dec << ", pCreateInfo = 0x" << nouppercase <<  hex << HandleCast(pCreateInfo) << dec << ", pAllocator = 0x" << nouppercase <<  hex << HandleCast(pAllocator) << dec << ", " << (pFramebuffer ? "*" : "") << "pFramebuffer = 0x" << nouppercase <<  hex << (pFramebuffer ? HandleCast(*pFramebuffer) : 0) << dec << ") = " << string_VkResult((VkResult)result) << endl;
    }
    else {
        (*outputStream) << "t{" << getTIDIndex() << "} vkCreateFramebuffer(device = address, pCreateInfo = address, pAllocator = address, pFramebuffer = address) = " << string_VkResult((VkResult)result) << endl;
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1100
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
...
VK_LAYER_EXPORT VKAPI_ATTR void VKAPI_CALL vkDestroyFramebuffer(VkDevice device, VkFramebuffer framebuffer, const VkAllocationCallbacks* pAllocator)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkDestroyFramebuffer(device = 0x" << nouppercase <<  hex << HandleCast(device) << dec << ", framebuffer = 0x" << nouppercase <<  hex << HandleCast(framebuffer) << dec << ", pAllocator = 0x" << nouppercase <<  hex << HandleCast(pAllocator) << dec << ")\n";
    }
    else {
        (*outputStream) << "t{" << getTIDIndex() << "} vkDestroyFramebuffer(device = address, framebuffer = address, pAllocator = address)\n";
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1100
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
...
VK_LAYER_EXPORT VKAPI_ATTR VkResult VKAPI_CALL vkCreateRenderPass(VkDevice device, const VkRenderPassCreateInfo* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkRenderPass* pRenderPass)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkCreateRenderPass(device = 0x" << nouppercase <<  hex << HandleCast(device) << dec << ", pCreateInfo = 0x" << nouppercase <<  hex << HandleCast(pCreateInfo) << dec << ", pAllocator = 0x" << nouppercase <<  hex << HandleCast(pAllocator) << dec << ", " << (pRenderPass ? "*" : "") << "pRenderPass = 0x" << nouppercase <<  hex << (pRenderPass ? HandleCast(*pRenderPass) : 0) << dec << ") = " << string_VkResult((VkResult)result) << endl;
    }
    else {
        (*outputStream) << "t{" << getTIDIndex() << "} vkCreateRenderPass(device = address, pCreateInfo = address, pAllocator = address, pRenderPass = address) = " << string_VkResult((VkResult)result) << endl;
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1100
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
...
VK_LAYER_EXPORT VKAPI_ATTR void VKAPI_CALL vkDestroyRenderPass(VkDevice device, VkRenderPass renderPass, const VkAllocationCallbacks* pAllocator)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkDestroyRenderPass(device = 0x" << nouppercase <<  hex << HandleCast(device) << dec << ", renderPass = 0x" << nouppercase <<  hex << HandleCast(renderPass) << dec << ", pAllocator = 0x" << nouppercase <<  hex << HandleCast(pAllocator) << dec << ")\n";
    }
    else {
        (*outputStream) << "t{" << getTIDIndex() << "} vkDestroyRenderPass(device = address, renderPass = address, pAllocator = address)\n";
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1100
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
...
VK_LAYER_EXPORT VKAPI_ATTR void VKAPI_CALL vkGetRenderAreaGranularity(VkDevice device, VkRenderPass renderPass, VkExtent2D* pGranularity)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkGetRenderAreaGranularity(device = 0x" << nouppercase <<  hex << HandleCast(device) << dec << ", renderPass = 0x" << nouppercase <<  hex << HandleCast(renderPass) << dec << ", pGranularity = 0x" << nouppercase <<  hex << HandleCast(pGranularity) << dec << ")\n";
    }
    else {
        (*outputStream) << "t{" << getTIDIndex() << "} vkGetRenderAreaGranularity(device = address, renderPass = address, pGranularity = address)\n";
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1100
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
...
VK_LAYER_EXPORT VKAPI_ATTR void VKAPI_CALL vkDestroyCommandPool(VkDevice device, VkCommandPool commandPool, const VkAllocationCallbacks* pAllocator)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkDestroyCommandPool(device = 0x" << nouppercase <<  hex << HandleCast(device) << dec << ", commandPool = 0x" << nouppercase <<  hex << HandleCast(commandPool) << dec << ", pAllocator = 0x" << nouppercase <<  hex << HandleCast(pAllocator) << dec << ")\n";
    }
    else {
        (*outputStream) << "t{" << getTIDIndex() << "} vkDestroyCommandPool(device = address, commandPool = address, pAllocator = address)\n";
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1100
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
...
VK_LAYER_EXPORT VKAPI_ATTR VkResult VKAPI_CALL vkResetCommandPool(VkDevice device, VkCommandPool commandPool, VkCommandPoolResetFlags flags)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkResetCommandPool(device = 0x" << nouppercase <<  hex << HandleCast(device) << dec << ", commandPool = 0x" << nouppercase <<  hex << HandleCast(commandPool) << dec << ", flags = 0x" << nouppercase <<  hex << flags << dec << ") = " << string_VkResult((VkResult)result) << endl;
    }
    else {
        (*outputStream) << "t{" << getTIDIndex() << "} vkResetCommandPool(device = address, commandPool = address, flags = address) = " << string_VkResult((VkResult)result) << endl;
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1100
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
...
VK_LAYER_EXPORT VKAPI_ATTR VkResult VKAPI_CALL vkAllocateCommandBuffers(VkDevice device, const VkCommandBufferAllocateInfo* pAllocateInfo, VkCommandBuffer* pCommandBuffers)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkAllocateCommandBuffers(device = 0x" << nouppercase <<  hex << HandleCast(device) << dec << ", pAllocateInfo = 0x" << nouppercase <<  hex << HandleCast(pAllocateInfo) << dec << ", " << (pCommandBuffers ? "*" : "") << "pCommandBuffers = 0x" << nouppercase <<  hex << (pCommandBuffers ? HandleCast(*pCommandBuffers) : 0) << dec << ") = " << string_VkResult((VkResult)result) << endl;
    }
    else {
...
VK_LAYER_EXPORT VKAPI_ATTR VkResult VKAPI_CALL vkBeginCommandBuffer(VkCommandBuffer commandBuffer, const VkCommandBufferBeginInfo* pBeginInfo)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkBeginCommandBuffer(commandBuffer = 0x" << nouppercase <<  hex << HandleCast(commandBuffer) << dec << ", pBeginInfo = 0x" << nouppercase <<  hex << HandleCast(pBeginInfo) << dec << ") = " << string_VkResult((VkResult)result) << endl;
    }
    else {
...
VK_LAYER_EXPORT VKAPI_ATTR VkResult VKAPI_CALL vkEndCommandBuffer(VkCommandBuffer commandBuffer)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkEndCommandBuffer(commandBuffer = 0x" << nouppercase <<  hex << HandleCast(commandBuffer) << dec << ") = " << string_VkResult((VkResult)result) << endl;
    }
    else {
...
VK_LAYER_EXPORT VKAPI_ATTR VkResult VKAPI_CALL vkResetCommandBuffer(VkCommandBuffer commandBuffer, VkCommandBufferResetFlags flags)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkResetCommandBuffer(commandBuffer = 0x" << nouppercase <<  hex << HandleCast(commandBuffer) << dec << ", flags = 0x" << nouppercase <<  hex << flags << dec << ") = " << string_VkResult((VkResult)result) << endl;
    }
    else {
        (*outputStream) << "t{" << getTIDIndex() << "} vkResetCommandBuffer(commandBuffer = address, flags = address) = " << string_VkResult((VkResult)result) << endl;
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1100
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
...
VK_LAYER_EXPORT VKAPI_ATTR void VKAPI_CALL vkCmdBindPipeline(VkCommandBuffer commandBuffer, VkPipelineBindPoint pipelineBindPoint, VkPipeline pipeline)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkCmdBindPipeline(commandBuffer = 0x" << nouppercase <<  hex << HandleCast(commandBuffer) << dec << ", pipelineBindPoint = " << string_VkPipelineBindPoint(pipelineBindPoint) << ", pipeline = 0x" << nouppercase <<  hex << HandleCast(pipeline) << dec << ")\n";
    }
    else {
        (*outputStream) << "t{" << getTIDIndex() << "} vkCmdBindPipeline(commandBuffer = address, pipelineBindPoint = " << string_VkPipelineBindPoint(pipelineBindPoint) << ", pipeline = address)\n";
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1100
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
...
VK_LAYER_EXPORT VKAPI_ATTR void VKAPI_CALL vkCmdSetViewport(VkCommandBuffer commandBuffer, uint32_t firstViewport, uint32_t viewportCount, const VkViewport* pViewports)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkCmdSetViewport(commandBuffer = 0x" << nouppercase <<  hex << HandleCast(commandBuffer) << dec << ", firstViewport = 0x" << nouppercase <<  hex << firstViewport << dec << ", viewportCount = 0x" << nouppercase <<  hex << viewportCount << dec << ", pViewports = 0x" << nouppercase <<  hex << HandleCast(pViewports) << dec << ")\n";
    }
    else {
        (*outputStream) << "t{" << getTIDIndex() << "} vkCmdSetViewport(commandBuffer = address, firstViewport = address, viewportCount = address, pViewports = address)\n";
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1100
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
...
VK_LAYER_EXPORT VKAPI_ATTR void VKAPI_CALL vkCmdSetScissor(VkCommandBuffer commandBuffer, uint32_t firstScissor, uint32_t scissorCount, const VkRect2D* pScissors)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkCmdSetScissor(commandBuffer = 0x" << nouppercase <<  hex << HandleCast(commandBuffer) << dec << ", firstScissor = 0x" << nouppercase <<  hex << firstScissor << dec << ", scissorCount = 0x" << nouppercase <<  hex << scissorCount << dec << ", pScissors = 0x" << nouppercase <<  hex << HandleCast(pScissors) << dec << ")\n";
    }
    else {
        (*outputStream) << "t{" << getTIDIndex() << "} vkCmdSetScissor(commandBuffer = address, firstScissor = address, scissorCount = address, pScissors = address)\n";
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1100
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
...
VK_LAYER_EXPORT VKAPI_ATTR void VKAPI_CALL vkCmdSetLineWidth(VkCommandBuffer commandBuffer, float lineWidth)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkCmdSetLineWidth(commandBuffer = 0x" << nouppercase <<  hex << HandleCast(commandBuffer) << dec << ", lineWidth = " << lineWidth << ")\n";
    }
    else {
...
VK_LAYER_EXPORT VKAPI_ATTR void VKAPI_CALL vkCmdSetDepthBias(VkCommandBuffer commandBuffer, float depthBiasConstantFactor, float depthBiasClamp, float depthBiasSlopeFactor)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkCmdSetDepthBias(commandBuffer = 0x" << nouppercase <<  hex << HandleCast(commandBuffer) << dec << ", depthBiasConstantFactor = " << depthBiasConstantFactor << ", depthBiasClamp = " << depthBiasClamp << ", depthBiasSlopeFactor = " << depthBiasSlopeFactor << ")\n";
    }
    else {
...
VK_LAYER_EXPORT VKAPI_ATTR void VKAPI_CALL vkCmdSetBlendConstants(VkCommandBuffer commandBuffer, const float blendConstants[4])
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkCmdSetBlendConstants(commandBuffer = 0x" << nouppercase <<  hex << HandleCast(commandBuffer) << dec << ", blendConstants = " << "[" << blendConstants[0] << "," << blendConstants[1] << "," << blendConstants[2] << "," << blendConstants[3] << "]" << ")\n";
    }
    else {
...
VK_LAYER_EXPORT VKAPI_ATTR void VKAPI_CALL vkCmdSetDepthBounds(VkCommandBuffer commandBuffer, float minDepthBounds, float maxDepthBounds)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkCmdSetDepthBounds(commandBuffer = 0x" << nouppercase <<  hex << HandleCast(commandBuffer) << dec << ", minDepthBounds = " << minDepthBounds << ", maxDepthBounds = " << maxDepthBounds << ")\n";
    }
    else {
...
VK_LAYER_EXPORT VKAPI_ATTR void VKAPI_CALL vkCmdSetStencilCompareMask(VkCommandBuffer commandBuffer, VkStencilFaceFlags faceMask, uint32_t compareMask)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkCmdSetStencilCompareMask(commandBuffer = 0x" << nouppercase <<  hex << HandleCast(commandBuffer) << dec << ", faceMask = 0x" << nouppercase <<  hex << faceMask << dec << ", compareMask = 0x" << nouppercase <<  hex << compareMask << dec << ")\n";
    }
    else {
        (*outputStream) << "t{" << getTIDIndex() << "} vkCmdSetStencilCompareMask(commandBuffer = address, faceMask = address, compareMask = address)\n";
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1100
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
...
VK_LAYER_EXPORT VKAPI_ATTR void VKAPI_CALL vkCmdSetStencilWriteMask(VkCommandBuffer commandBuffer, VkStencilFaceFlags faceMask, uint32_t writeMask)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkCmdSetStencilWriteMask(commandBuffer = 0x" << nouppercase <<  hex << HandleCast(commandBuffer) << dec << ", faceMask = 0x" << nouppercase <<  hex << faceMask << dec << ", writeMask = 0x" << nouppercase <<  hex << writeMask << dec << ")\n";
    }
    else {
        (*outputStream) << "t{" << getTIDIndex() << "} vkCmdSetStencilWriteMask(commandBuffer = address, faceMask = address, writeMask = address)\n";
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1100
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
...
VK_LAYER_EXPORT VKAPI_ATTR void VKAPI_CALL vkCmdSetStencilReference(VkCommandBuffer commandBuffer, VkStencilFaceFlags faceMask, uint32_t reference)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkCmdSetStencilReference(commandBuffer = 0x" << nouppercase <<  hex << HandleCast(commandBuffer) << dec << ", faceMask = 0x" << nouppercase <<  hex << faceMask << dec << ", reference = 0x" << nouppercase <<  hex << reference << dec << ")\n";
    }
    else {
        (*outputStream) << "t{" << getTIDIndex() << "} vkCmdSetStencilReference(commandBuffer = address, faceMask = address, reference = address)\n";
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1100
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
...
VK_LAYER_EXPORT VKAPI_ATTR void VKAPI_CALL vkCmdBindDescriptorSets(VkCommandBuffer commandBuffer, VkPipelineBindPoint pipelineBindPoint, VkPipelineLayout layout, uint32_t firstSet, uint32_t descriptorSetCount, const VkDescriptorSet* pDescriptorSets, uint32_t dynamicOffsetCount, const uint32_t* pDynamicOffsets)
{
    ...
    if (StreamControl::writeAddress == true) {
        ...
        (*outputStream) << "t{" << getTIDIndex() << "} vkCmdBindDescriptorSets(commandBuffer = address, pipelineBindPoint = " << string_VkPipelineBindPoint(pipelineBindPoint) << ", layout = address, firstSet = address, descriptorSetCount = address, pDescriptorSets = address, dynamicOffsetCount = address, pDynamicOffsets = address)\n";
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1100
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
...
VK_LAYER_EXPORT VKAPI_ATTR void VKAPI_CALL vkCmdBindIndexBuffer(VkCommandBuffer commandBuffer, VkBuffer buffer, VkDeviceSize offset, VkIndexType indexType)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkCmdBindIndexBuffer(commandBuffer = 0x" << nouppercase <<  hex << HandleCast(commandBuffer) << dec << ", buffer = 0x" << nouppercase <<  hex << HandleCast(buffer) << dec << ", offset = 0x" << nouppercase <<  hex << offset << dec << ", indexType = " << string_VkIndexType(indexType) << ")\n";
    }
    else {
        (*outputStream) << "t{" << getTIDIndex() << "} vkCmdBindIndexBuffer(commandBuffer = address, buffer = address, offset = address, indexType = " << string_VkIndexType(indexType) << ")\n";
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1100
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
...
VK_LAYER_EXPORT VKAPI_ATTR void VKAPI_CALL vkCmdBindVertexBuffers(VkCommandBuffer commandBuffer, uint32_t firstBinding, uint32_t bindingCount, const VkBuffer* pBuffers, const VkDeviceSize* pOffsets)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkCmdBindVertexBuffers(commandBuffer = 0x" << nouppercase <<  hex << HandleCast(commandBuffer) << dec << ", firstBinding = 0x" << nouppercase <<  hex << firstBinding << dec << ", bindingCount = 0x" << nouppercase <<  hex << bindingCount << dec << ", " << (pBuffers ? "*" : "") << "pBuffers = 0x" << nouppercase <<  hex << (pBuffers ? HandleCast(*pBuffers) : 0) << dec << ", " << (pOffsets ? "*" : "") << "pOffsets = 0x" << nouppercase <<  hex << (pOffsets ? *pOffsets : 0) << dec << ")\n";
    }
    else {
        (*outputStream) << "t{" << getTIDIndex() << "} vkCmdBindVertexBuffers(commandBuffer = address, firstBinding = address, bindingCount = address, pBuffers = address, pOffsets = address)\n";
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1100
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
...
VK_LAYER_EXPORT VKAPI_ATTR void VKAPI_CALL vkCmdDraw(VkCommandBuffer commandBuffer, uint32_t vertexCount, uint32_t instanceCount, uint32_t firstVertex, uint32_t firstInstance)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkCmdDraw(commandBuffer = 0x" << nouppercase <<  hex << HandleCast(commandBuffer) << dec << ", vertexCount = 0x" << nouppercase <<  hex << vertexCount << dec << ", instanceCount = 0x" << nouppercase <<  hex << instanceCount << dec << ", firstVertex = 0x" << nouppercase <<  hex << firstVertex << dec << ", firstInstance = 0x" << nouppercase <<  hex << firstInstance << dec << ")\n";
    }
    else {
        (*outputStream) << "t{" << getTIDIndex() << "} vkCmdDraw(commandBuffer = address, vertexCount = address, instanceCount = address, firstVertex = address, firstInstance = address)\n";
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1100
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
...
VK_LAYER_EXPORT VKAPI_ATTR void VKAPI_CALL vkCmdDrawIndexed(VkCommandBuffer commandBuffer, uint32_t indexCount, uint32_t instanceCount, uint32_t firstIndex, int32_t vertexOffset, uint32_t firstInstance)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkCmdDrawIndexed(commandBuffer = 0x" << nouppercase <<  hex << HandleCast(commandBuffer) << dec << ", indexCount = 0x" << nouppercase <<  hex << indexCount << dec << ", instanceCount = 0x" << nouppercase <<  hex << instanceCount << dec << ", firstIndex = 0x" << nouppercase <<  hex << firstIndex << dec << ", vertexOffset = 0x" << nouppercase <<  hex << vertexOffset << dec << ", firstInstance = 0x" << nouppercase <<  hex << firstInstance << dec << ")\n";
    }
    else {
        (*outputStream) << "t{" << getTIDIndex() << "} vkCmdDrawIndexed(commandBuffer = address, indexCount = address, instanceCount = address, firstIndex = address, vertexOffset = address, firstInstance = address)\n";
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1100
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
...
VK_LAYER_EXPORT VKAPI_ATTR void VKAPI_CALL vkCmdDrawIndirect(VkCommandBuffer commandBuffer, VkBuffer buffer, VkDeviceSize offset, uint32_t drawCount, uint32_t stride)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkCmdDrawIndirect(commandBuffer = 0x" << nouppercase <<  hex << HandleCast(commandBuffer) << dec << ", buffer = 0x" << nouppercase <<  hex << HandleCast(buffer) << dec << ", offset = 0x" << nouppercase <<  hex << offset << dec << ", drawCount = 0x" << nouppercase <<  hex << drawCount << dec << ", stride = 0x" << nouppercase <<  hex << stride << dec << ")\n";
    }
    else {
        (*outputStream) << "t{" << getTIDIndex() << "} vkCmdDrawIndirect(commandBuffer = address, buffer = address, offset = address, drawCount = address, stride = address)\n";
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1100
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
...
VK_LAYER_EXPORT VKAPI_ATTR void VKAPI_CALL vkCmdDrawIndexedIndirect(VkCommandBuffer commandBuffer, VkBuffer buffer, VkDeviceSize offset, uint32_t drawCount, uint32_t stride)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkCmdDrawIndexedIndirect(commandBuffer = 0x" << nouppercase <<  hex << HandleCast(commandBuffer) << dec << ", buffer = 0x" << nouppercase <<  hex << HandleCast(buffer) << dec << ", offset = 0x" << nouppercase <<  hex << offset << dec << ", drawCount = 0x" << nouppercase <<  hex << drawCount << dec << ", stride = 0x" << nouppercase <<  hex << stride << dec << ")\n";
    }
    else {
        (*outputStream) << "t{" << getTIDIndex() << "} vkCmdDrawIndexedIndirect(commandBuffer = address, buffer = address, offset = address, drawCount = address, stride = address)\n";
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1100
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
...
VK_LAYER_EXPORT VKAPI_ATTR void VKAPI_CALL vkCmdDispatch(VkCommandBuffer commandBuffer, uint32_t x, uint32_t y, uint32_t z)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkCmdDispatch(commandBuffer = 0x" << nouppercase <<  hex << HandleCast(commandBuffer) << dec << ", x = 0x" << nouppercase <<  hex << x << dec << ", y = 0x" << nouppercase <<  hex << y << dec << ", z = 0x" << nouppercase <<  hex << z << dec << ")\n";
    }
    else {
        (*outputStream) << "t{" << getTIDIndex() << "} vkCmdDispatch(commandBuffer = address, x = address, y = address, z = address)\n";
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1100
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
...
VK_LAYER_EXPORT VKAPI_ATTR void VKAPI_CALL vkCmdDispatchIndirect(VkCommandBuffer commandBuffer, VkBuffer buffer, VkDeviceSize offset)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkCmdDispatchIndirect(commandBuffer = 0x" << nouppercase <<  hex << HandleCast(commandBuffer) << dec << ", buffer = 0x" << nouppercase <<  hex << HandleCast(buffer) << dec << ", offset = 0x" << nouppercase <<  hex << offset << dec << ")\n";
    }
    else {
        (*outputStream) << "t{" << getTIDIndex() << "} vkCmdDispatchIndirect(commandBuffer = address, buffer = address, offset = address)\n";
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1100
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
...
VK_LAYER_EXPORT VKAPI_ATTR void VKAPI_CALL vkCmdCopyImage(VkCommandBuffer commandBuffer, VkImage srcImage, VkImageLayout srcImageLayout, VkImage dstImage, VkImageLayout dstImageLayout, uint32_t regionCount, const VkImageCopy* pRegions)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkCmdCopyImage(commandBuffer = 0x" << nouppercase <<  hex << HandleCast(commandBuffer) << dec << ", srcImage = 0x" << nouppercase <<  hex << HandleCast(srcImage) << dec << ", srcImageLayout = " << string_VkImageLayout(srcImageLayout) << ", dstImage = 0x" << nouppercase <<  hex << HandleCast(dstImage) << dec << ", dstImageLayout = " << string_VkImageLayout(dstImageLayout) << ", regionCount = 0x" << nouppercase <<  hex << regionCount << dec << ", pRegions = 0x" << nouppercase <<  hex << HandleCast(pRegions) << dec << ")\n";
    }
    else {
        (*outputStream) << "t{" << getTIDIndex() << "} vkCmdCopyImage(commandBuffer = address, srcImage = address, srcImageLayout = " << string_VkImageLayout(srcImageLayout) << ", dstImage = address, dstImageLayout = " << string_VkImageLayout(dstImageLayout) << ", regionCount = address, pRegions = address)\n";
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1100
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
...
VK_LAYER_EXPORT VKAPI_ATTR void VKAPI_CALL vkCmdBlitImage(VkCommandBuffer commandBuffer, VkImage srcImage, VkImageLayout srcImageLayout, VkImage dstImage, VkImageLayout dstImageLayout, uint32_t regionCount, const VkImageBlit* pRegions, VkFilter filter)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkCmdBlitImage(commandBuffer = 0x" << nouppercase <<  hex << HandleCast(commandBuffer) << dec << ", srcImage = 0x" << nouppercase <<  hex << HandleCast(srcImage) << dec << ", srcImageLayout = " << string_VkImageLayout(srcImageLayout) << ", dstImage = 0x" << nouppercase <<  hex << HandleCast(dstImage) << dec << ", dstImageLayout = " << string_VkImageLayout(dstImageLayout) << ", regionCount = 0x" << nouppercase <<  hex << regionCount << dec << ", pRegions = 0x" << nouppercase <<  hex << HandleCast(pRegions) << dec << ", filter = " << string_VkFilter(filter) << ")\n";
    }
    else {
        (*outputStream) << "t{" << getTIDIndex() << "} vkCmdBlitImage(commandBuffer = address, srcImage = address, srcImageLayout = " << string_VkImageLayout(srcImageLayout) << ", dstImage = address, dstImageLayout = " << string_VkImageLayout(dstImageLayout) << ", regionCount = address, pRegions = address, filter = " << string_VkFilter(filter) << ")\n";
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1100
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
...
VK_LAYER_EXPORT VKAPI_ATTR void VKAPI_CALL vkCmdCopyBufferToImage(VkCommandBuffer commandBuffer, VkBuffer srcBuffer, VkImage dstImage, VkImageLayout dstImageLayout, uint32_t regionCount, const VkBufferImageCopy* pRegions)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkCmdCopyBufferToImage(commandBuffer = 0x" << nouppercase <<  hex << HandleCast(commandBuffer) << dec << ", srcBuffer = 0x" << nouppercase <<  hex << HandleCast(srcBuffer) << dec << ", dstImage = 0x" << nouppercase <<  hex << HandleCast(dstImage) << dec << ", dstImageLayout = " << string_VkImageLayout(dstImageLayout) << ", regionCount = 0x" << nouppercase <<  hex << regionCount << dec << ", pRegions = 0x" << nouppercase <<  hex << HandleCast(pRegions) << dec << ")\n";
    }
    else {
        (*outputStream) << "t{" << getTIDIndex() << "} vkCmdCopyBufferToImage(commandBuffer = address, srcBuffer = address, dstImage = address, dstImageLayout = " << string_VkImageLayout(dstImageLayout) << ", regionCount = address, pRegions = address)\n";
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1100
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
...
VK_LAYER_EXPORT VKAPI_ATTR void VKAPI_CALL vkCmdCopyImageToBuffer(VkCommandBuffer commandBuffer, VkImage srcImage, VkImageLayout srcImageLayout, VkBuffer dstBuffer, uint32_t regionCount, const VkBufferImageCopy* pRegions)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkCmdCopyImageToBuffer(commandBuffer = 0x" << nouppercase <<  hex << HandleCast(commandBuffer) << dec << ", srcImage = 0x" << nouppercase <<  hex << HandleCast(srcImage) << dec << ", srcImageLayout = " << string_VkImageLayout(srcImageLayout) << ", dstBuffer = 0x" << nouppercase <<  hex << HandleCast(dstBuffer) << dec << ", regionCount = 0x" << nouppercase <<  hex << regionCount << dec << ", pRegions = 0x" << nouppercase <<  hex << HandleCast(pRegions) << dec << ")\n";
    }
    else {
        (*outputStream) << "t{" << getTIDIndex() << "} vkCmdCopyImageToBuffer(commandBuffer = address, srcImage = address, srcImageLayout = " << string_VkImageLayout(srcImageLayout) << ", dstBuffer = address, regionCount = address, pRegions = address)\n";
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1100
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
...
VK_LAYER_EXPORT VKAPI_ATTR void VKAPI_CALL vkCmdUpdateBuffer(VkCommandBuffer commandBuffer, VkBuffer dstBuffer, VkDeviceSize dstOffset, VkDeviceSize dataSize, const void* pData)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkCmdUpdateBuffer(commandBuffer = 0x" << nouppercase <<  hex << HandleCast(commandBuffer) << dec << ", dstBuffer = 0x" << nouppercase <<  hex << HandleCast(dstBuffer) << dec << ", dstOffset = 0x" << nouppercase <<  hex << dstOffset << dec << ", dataSize = 0x" << nouppercase <<  hex << dataSize << dec << ", pData = 0x" << nouppercase <<  hex << HandleCast(pData) << dec << ")\n";
    }
    else {
        (*outputStream) << "t{" << getTIDIndex() << "} vkCmdUpdateBuffer(commandBuffer = address, dstBuffer = address, dstOffset = address, dataSize = address, pData = address)\n";
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1100
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
...
VK_LAYER_EXPORT VKAPI_ATTR void VKAPI_CALL vkCmdFillBuffer(VkCommandBuffer commandBuffer, VkBuffer dstBuffer, VkDeviceSize dstOffset, VkDeviceSize size, uint32_t data)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkCmdFillBuffer(commandBuffer = 0x" << nouppercase <<  hex << HandleCast(commandBuffer) << dec << ", dstBuffer = 0x" << nouppercase <<  hex << HandleCast(dstBuffer) << dec << ", dstOffset = 0x" << nouppercase <<  hex << dstOffset << dec << ", size = 0x" << nouppercase <<  hex << size << dec << ", data = 0x" << nouppercase <<  hex << data << dec << ")\n";
    }
    else {
        (*outputStream) << "t{" << getTIDIndex() << "} vkCmdFillBuffer(commandBuffer = address, dstBuffer = address, dstOffset = address, size = address, data = address)\n";
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1100
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
...
VK_LAYER_EXPORT VKAPI_ATTR void VKAPI_CALL vkCmdClearColorImage(VkCommandBuffer commandBuffer, VkImage image, VkImageLayout imageLayout, const VkClearColorValue* pColor, uint32_t rangeCount, const VkImageSubresourceRange* pRanges)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkCmdClearColorImage(commandBuffer = 0x" << nouppercase <<  hex << HandleCast(commandBuffer) << dec << ", image = 0x" << nouppercase <<  hex << HandleCast(image) << dec << ", imageLayout = " << string_VkImageLayout(imageLayout) << ", pColor = 0x" << nouppercase <<  hex << HandleCast(pColor) << dec << ", rangeCount = 0x" << nouppercase <<  hex << rangeCount << dec << ", pRanges = 0x" << nouppercase <<  hex << HandleCast(pRanges) << dec << ")\n";
    }
    else {
        (*outputStream) << "t{" << getTIDIndex() << "} vkCmdClearColorImage(commandBuffer = address, image = address, imageLayout = " << string_VkImageLayout(imageLayout) << ", pColor = address, rangeCount = address, pRanges = address)\n";
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1100
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
...
VK_LAYER_EXPORT VKAPI_ATTR void VKAPI_CALL vkCmdClearDepthStencilImage(VkCommandBuffer commandBuffer, VkImage image, VkImageLayout imageLayout, const VkClearDepthStencilValue* pDepthStencil, uint32_t rangeCount, const VkImageSubresourceRange* pRanges)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkCmdClearDepthStencilImage(commandBuffer = 0x" << nouppercase <<  hex << HandleCast(commandBuffer) << dec << ", image = 0x" << nouppercase <<  hex << HandleCast(image) << dec << ", imageLayout = " << string_VkImageLayout(imageLayout) << ", pDepthStencil = 0x" << nouppercase <<  hex << HandleCast(pDepthStencil) << dec << ", rangeCount = 0x" << nouppercase <<  hex << rangeCount << dec << ", pRanges = 0x" << nouppercase <<  hex << HandleCast(pRanges) << dec << ")\n";
    }
    else {
        (*outputStream) << "t{" << getTIDIndex() << "} vkCmdClearDepthStencilImage(commandBuffer = address, image = address, imageLayout = " << string_VkImageLayout(imageLayout) << ", pDepthStencil = address, rangeCount = address, pRanges = address)\n";
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1100
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
...
VK_LAYER_EXPORT VKAPI_ATTR void VKAPI_CALL vkCmdClearAttachments(VkCommandBuffer commandBuffer, uint32_t attachmentCount, const VkClearAttachment* pAttachments, uint32_t rectCount, const VkClearRect* pRects)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkCmdClearAttachments(commandBuffer = 0x" << nouppercase <<  hex << HandleCast(commandBuffer) << dec << ", attachmentCount = 0x" << nouppercase <<  hex << attachmentCount << dec << ", pAttachments = 0x" << nouppercase <<  hex << HandleCast(pAttachments) << dec << ", rectCount = 0x" << nouppercase <<  hex << rectCount << dec << ", pRects = 0x" << nouppercase <<  hex << HandleCast(pRects) << dec << ")\n";
    }
    else {
        (*outputStream) << "t{" << getTIDIndex() << "} vkCmdClearAttachments(commandBuffer = address, attachmentCount = address, pAttachments = address, rectCount = address, pRects = address)\n";
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1100
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
...
VK_LAYER_EXPORT VKAPI_ATTR void VKAPI_CALL vkCmdResolveImage(VkCommandBuffer commandBuffer, VkImage srcImage, VkImageLayout srcImageLayout, VkImage dstImage, VkImageLayout dstImageLayout, uint32_t regionCount, const VkImageResolve* pRegions)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkCmdResolveImage(commandBuffer = 0x" << nouppercase <<  hex << HandleCast(commandBuffer) << dec << ", srcImage = 0x" << nouppercase <<  hex << HandleCast(srcImage) << dec << ", srcImageLayout = " << string_VkImageLayout(srcImageLayout) << ", dstImage = 0x" << nouppercase <<  hex << HandleCast(dstImage) << dec << ", dstImageLayout = " << string_VkImageLayout(dstImageLayout) << ", regionCount = 0x" << nouppercase <<  hex << regionCount << dec << ", pRegions = 0x" << nouppercase <<  hex << HandleCast(pRegions) << dec << ")\n";
    }
    else {
        (*outputStream) << "t{" << getTIDIndex() << "} vkCmdResolveImage(commandBuffer = address, srcImage = address, srcImageLayout = " << string_VkImageLayout(srcImageLayout) << ", dstImage = address, dstImageLayout = " << string_VkImageLayout(dstImageLayout) << ", regionCount = address, pRegions = address)\n";
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1100
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
...
VK_LAYER_EXPORT VKAPI_ATTR void VKAPI_CALL vkCmdSetEvent(VkCommandBuffer commandBuffer, VkEvent event, VkPipelineStageFlags stageMask)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkCmdSetEvent(commandBuffer = 0x" << nouppercase <<  hex << HandleCast(commandBuffer) << dec << ", event = 0x" << nouppercase <<  hex << HandleCast(event) << dec << ", stageMask = 0x" << nouppercase <<  hex << stageMask << dec << ")\n";
    }
    else {
        (*outputStream) << "t{" << getTIDIndex() << "} vkCmdSetEvent(commandBuffer = address, event = address, stageMask = address)\n";
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1100
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
...
VK_LAYER_EXPORT VKAPI_ATTR void VKAPI_CALL vkCmdResetEvent(VkCommandBuffer commandBuffer, VkEvent event, VkPipelineStageFlags stageMask)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkCmdResetEvent(commandBuffer = 0x" << nouppercase <<  hex << HandleCast(commandBuffer) << dec << ", event = 0x" << nouppercase <<  hex << HandleCast(event) << dec << ", stageMask = 0x" << nouppercase <<  hex << stageMask << dec << ")\n";
    }
    else {
        (*outputStream) << "t{" << getTIDIndex() << "} vkCmdResetEvent(commandBuffer = address, event = address, stageMask = address)\n";
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1100
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
...
VK_LAYER_EXPORT VKAPI_ATTR void VKAPI_CALL vkCmdBeginQuery(VkCommandBuffer commandBuffer, VkQueryPool queryPool, uint32_t query, VkQueryControlFlags flags)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkCmdBeginQuery(commandBuffer = 0x" << nouppercase <<  hex << HandleCast(commandBuffer) << dec << ", queryPool = 0x" << nouppercase <<  hex << HandleCast(queryPool) << dec << ", query = 0x" << nouppercase <<  hex << query << dec << ", flags = 0x" << nouppercase <<  hex << flags << dec << ")\n";
    }
    else {
        (*outputStream) << "t{" << getTIDIndex() << "} vkCmdBeginQuery(commandBuffer = address, queryPool = address, query = address, flags = address)\n";
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1100
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
...
VK_LAYER_EXPORT VKAPI_ATTR void VKAPI_CALL vkCmdEndQuery(VkCommandBuffer commandBuffer, VkQueryPool queryPool, uint32_t query)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkCmdEndQuery(commandBuffer = 0x" << nouppercase <<  hex << HandleCast(commandBuffer) << dec << ", queryPool = 0x" << nouppercase <<  hex << HandleCast(queryPool) << dec << ", query = 0x" << nouppercase <<  hex << query << dec << ")\n";
    }
    else {
        (*outputStream) << "t{" << getTIDIndex() << "} vkCmdEndQuery(commandBuffer = address, queryPool = address, query = address)\n";
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1100
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
...
VK_LAYER_EXPORT VKAPI_ATTR void VKAPI_CALL vkCmdResetQueryPool(VkCommandBuffer commandBuffer, VkQueryPool queryPool, uint32_t firstQuery, uint32_t queryCount)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkCmdResetQueryPool(commandBuffer = 0x" << nouppercase <<  hex << HandleCast(commandBuffer) << dec << ", queryPool = 0x" << nouppercase <<  hex << HandleCast(queryPool) << dec << ", firstQuery = 0x" << nouppercase <<  hex << firstQuery << dec << ", queryCount = 0x" << nouppercase <<  hex << queryCount << dec << ")\n";
    }
    else {
        (*outputStream) << "t{" << getTIDIndex() << "} vkCmdResetQueryPool(commandBuffer = address, queryPool = address, firstQuery = address, queryCount = address)\n";
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1100
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
...
VK_LAYER_EXPORT VKAPI_ATTR void VKAPI_CALL vkCmdWriteTimestamp(VkCommandBuffer commandBuffer, VkPipelineStageFlagBits pipelineStage, VkQueryPool queryPool, uint32_t query)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkCmdWriteTimestamp(commandBuffer = 0x" << nouppercase <<  hex << HandleCast(commandBuffer) << dec << ", pipelineStage = " << string_VkPipelineStageFlagBits(pipelineStage) << ", queryPool = 0x" << nouppercase <<  hex << HandleCast(queryPool) << dec << ", query = 0x" << nouppercase <<  hex << query << dec << ")\n";
    }
    else {
        (*outputStream) << "t{" << getTIDIndex() << "} vkCmdWriteTimestamp(commandBuffer = address, pipelineStage = " << string_VkPipelineStageFlagBits(pipelineStage) << ", queryPool = address, query = address)\n";
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1100
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
...
VK_LAYER_EXPORT VKAPI_ATTR void VKAPI_CALL vkCmdCopyQueryPoolResults(VkCommandBuffer commandBuffer, VkQueryPool queryPool, uint32_t firstQuery, uint32_t queryCount, VkBuffer dstBuffer, VkDeviceSize dstOffset, VkDeviceSize stride, VkQueryResultFlags flags)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkCmdCopyQueryPoolResults(commandBuffer = 0x" << nouppercase <<  hex << HandleCast(commandBuffer) << dec << ", queryPool = 0x" << nouppercase <<  hex << HandleCast(queryPool) << dec << ", firstQuery = 0x" << nouppercase <<  hex << firstQuery << dec << ", queryCount = 0x" << nouppercase <<  hex << queryCount << dec << ", dstBuffer = 0x" << nouppercase <<  hex << HandleCast(dstBuffer) << dec << ", dstOffset = 0x" << nouppercase <<  hex << dstOffset << dec << ", stride = 0x" << nouppercase <<  hex << stride << dec << ", flags = 0x" << nouppercase <<  hex << flags << dec << ")\n";
    }
    else {
        (*outputStream) << "t{" << getTIDIndex() << "} vkCmdCopyQueryPoolResults(commandBuffer = address, queryPool = address, firstQuery = address, queryCount = address, dstBuffer = address, dstOffset = address, stride = address, flags = address)\n";
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1100
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
...
VK_LAYER_EXPORT VKAPI_ATTR void VKAPI_CALL vkCmdPushConstants(VkCommandBuffer commandBuffer, VkPipelineLayout layout, VkShaderStageFlags stageFlags, uint32_t offset, uint32_t size, const void* pValues)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkCmdPushConstants(commandBuffer = 0x" << nouppercase <<  hex << HandleCast(commandBuffer) << dec << ", layout = 0x" << nouppercase <<  hex << HandleCast(layout) << dec << ", stageFlags = 0x" << nouppercase <<  hex << stageFlags << dec << ", offset = 0x" << nouppercase <<  hex << offset << dec << ", size = 0x" << nouppercase <<  hex << size << dec << ", pValues = 0x" << nouppercase <<  hex << HandleCast(pValues) << dec << ")\n";
    }
    else {
        (*outputStream) << "t{" << getTIDIndex() << "} vkCmdPushConstants(commandBuffer = address, layout = address, stageFlags = address, offset = address, size = address, pValues = address)\n";
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1100
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
...
VK_LAYER_EXPORT VKAPI_ATTR void VKAPI_CALL vkCmdBeginRenderPass(VkCommandBuffer commandBuffer, const VkRenderPassBeginInfo* pRenderPassBegin, VkSubpassContents contents)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkCmdBeginRenderPass(commandBuffer = 0x" << nouppercase <<  hex << HandleCast(commandBuffer) << dec << ", pRenderPassBegin = 0x" << nouppercase <<  hex << HandleCast(pRenderPassBegin) << dec << ", contents = " << string_VkSubpassContents(contents) << ")\n";
    }
    else {
...
VK_LAYER_EXPORT VKAPI_ATTR void VKAPI_CALL vkCmdNextSubpass(VkCommandBuffer commandBuffer, VkSubpassContents contents)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkCmdNextSubpass(commandBuffer = 0x" << nouppercase <<  hex << HandleCast(commandBuffer) << dec << ", contents = " << string_VkSubpassContents(contents) << ")\n";
    }
    else {
...
VK_LAYER_EXPORT VKAPI_ATTR void VKAPI_CALL vkCmdEndRenderPass(VkCommandBuffer commandBuffer)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkCmdEndRenderPass(commandBuffer = 0x" << nouppercase <<  hex << HandleCast(commandBuffer) << dec << ")\n";
    }
    else {
...
VK_LAYER_EXPORT VKAPI_ATTR void VKAPI_CALL vkCmdExecuteCommands(VkCommandBuffer commandBuffer, uint32_t commandBufferCount, const VkCommandBuffer* pCommandBuffers)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkCmdExecuteCommands(commandBuffer = 0x" << nouppercase <<  hex << HandleCast(commandBuffer) << dec << ", commandBufferCount = 0x" << nouppercase <<  hex << commandBufferCount << dec << ", " << (pCommandBuffers ? "*" : "") << "pCommandBuffers = 0x" << nouppercase <<  hex << (pCommandBuffers ? HandleCast(*pCommandBuffers) : 0) << dec << ")\n";
    }
    else {
        (*outputStream) << "t{" << getTIDIndex() << "} vkCmdExecuteCommands(commandBuffer = address, commandBufferCount = address, pCommandBuffers = address)\n";
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1100
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
...
VK_LAYER_EXPORT VKAPI_ATTR void VKAPI_CALL vkDestroySurfaceKHR(VkInstance instance, VkSurfaceKHR surface, const VkAllocationCallbacks* pAllocator)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkDestroySurfaceKHR(instance = 0x" << nouppercase <<  hex << HandleCast(instance) << dec << ", surface = 0x" << nouppercase <<  hex << HandleCast(surface) << dec << ", pAllocator = 0x" << nouppercase <<  hex << HandleCast(pAllocator) << dec << ")\n";
    }
    else {
        (*outputStream) << "t{" << getTIDIndex() << "} vkDestroySurfaceKHR(instance = address, surface = address, pAllocator = address)\n";
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1100
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
...
VK_LAYER_EXPORT VKAPI_ATTR VkResult VKAPI_CALL vkGetPhysicalDeviceSurfaceSupportKHR(VkPhysicalDevice physicalDevice, uint32_t queueFamilyIndex, VkSurfaceKHR surface, VkBool32* pSupported)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkGetPhysicalDeviceSurfaceSupportKHR(physicalDevice = 0x" << nouppercase <<  hex << HandleCast(physicalDevice) << dec << ", queueFamilyIndex = 0x" << nouppercase <<  hex << queueFamilyIndex << dec << ", surface = 0x" << nouppercase <<  hex << HandleCast(surface) << dec << ", pSupported = " << pSupported << ") = " << string_VkResult((VkResult)result) << endl;
    }
    else {
        (*outputStream) << "t{" << getTIDIndex() << "} vkGetPhysicalDeviceSurfaceSupportKHR(physicalDevice = address, queueFamilyIndex = address, surface = address, pSupported = " << pSupported << ") = " << string_VkResult((VkResult)result) << endl;
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1100
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
...
VK_LAYER_EXPORT VKAPI_ATTR VkResult VKAPI_CALL vkGetPhysicalDeviceSurfaceCapabilitiesKHR(VkPhysicalDevice physicalDevice, VkSurfaceKHR surface, VkSurfaceCapabilitiesKHR* pSurfaceCapabilities)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkGetPhysicalDeviceSurfaceCapabilitiesKHR(physicalDevice = 0x" << nouppercase <<  hex << HandleCast(physicalDevice) << dec << ", surface = 0x" << nouppercase <<  hex << HandleCast(surface) << dec << ", pSurfaceCapabilities = 0x" << nouppercase <<  hex << HandleCast(pSurfaceCapabilities) << dec << ") = " << string_VkResult((VkResult)result) << endl;
    }
    else {
        (*outputStream) << "t{" << getTIDIndex() << "} vkGetPhysicalDeviceSurfaceCapabilitiesKHR(physicalDevice = address, surface = address, pSurfaceCapabilities = address) = " << string_VkResult((VkResult)result) << endl;
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1100
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
...
VK_LAYER_EXPORT VKAPI_ATTR VkResult VKAPI_CALL vkGetPhysicalDeviceSurfaceFormatsKHR(VkPhysicalDevice physicalDevice, VkSurfaceKHR surface, uint32_t* pSurfaceFormatCount, VkSurfaceFormatKHR* pSurfaceFormats)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkGetPhysicalDeviceSurfaceFormatsKHR(physicalDevice = 0x" << nouppercase <<  hex << HandleCast(physicalDevice) << dec << ", surface = 0x" << nouppercase <<  hex << HandleCast(surface) << dec << ", " << (pSurfaceFormatCount ? "*" : "") << "pSurfaceFormatCount = 0x" << nouppercase <<  hex << (pSurfaceFormatCount ? *pSurfaceFormatCount : 0) << dec << ", pSurfaceFormats = 0x" << nouppercase <<  hex << HandleCast(pSurfaceFormats) << dec << ") = " << string_VkResult((VkResult)result) << endl;
    }
    else {
        (*outputStream) << "t{" << getTIDIndex() << "} vkGetPhysicalDeviceSurfaceFormatsKHR(physicalDevice = address, surface = address, pSurfaceFormatCount = address, pSurfaceFormats = address) = " << string_VkResult((VkResult)result) << endl;
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1100
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
...
VK_LAYER_EXPORT VKAPI_ATTR VkResult VKAPI_CALL vkGetPhysicalDeviceSurfacePresentModesKHR(VkPhysicalDevice physicalDevice, VkSurfaceKHR surface, uint32_t* pPresentModeCount, VkPresentModeKHR* pPresentModes)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkGetPhysicalDeviceSurfacePresentModesKHR(physicalDevice = 0x" << nouppercase <<  hex << HandleCast(physicalDevice) << dec << ", surface = 0x" << nouppercase <<  hex << HandleCast(surface) << dec << ", " << (pPresentModeCount ? "*" : "") << "pPresentModeCount = 0x" << nouppercase <<  hex << (pPresentModeCount ? *pPresentModeCount : 0) << dec << ", pPresentModes = 0x" << nouppercase <<  hex << HandleCast(pPresentModes) << dec << ") = " << string_VkResult((VkResult)result) << endl;
    }
    else {
        (*outputStream) << "t{" << getTIDIndex() << "} vkGetPhysicalDeviceSurfacePresentModesKHR(physicalDevice = address, surface = address, pPresentModeCount = address, pPresentModes = address) = " << string_VkResult((VkResult)result) << endl;
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1100
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
...
VK_LAYER_EXPORT VKAPI_ATTR VkResult VKAPI_CALL vkCreateSwapchainKHR(VkDevice device, const VkSwapchainCreateInfoKHR* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkSwapchainKHR* pSwapchain)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkCreateSwapchainKHR(device = 0x" << nouppercase <<  hex << HandleCast(device) << dec << ", pCreateInfo = 0x" << nouppercase <<  hex << HandleCast(pCreateInfo) << dec << ", pAllocator = 0x" << nouppercase <<  hex << HandleCast(pAllocator) << dec << ", pSwapchain = 0x" << nouppercase <<  hex << HandleCast(pSwapchain) << dec << ") = " << string_VkResult((VkResult)result) << endl;
    }
    else {
        (*outputStream) << "t{" << getTIDIndex() << "} vkCreateSwapchainKHR(device = address, pCreateInfo = address, pAllocator = address, pSwapchain = address) = " << string_VkResult((VkResult)result) << endl;
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1100
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
...
VK_LAYER_EXPORT VKAPI_ATTR void VKAPI_CALL vkDestroySwapchainKHR(VkDevice device, VkSwapchainKHR swapchain, const VkAllocationCallbacks* pAllocator)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkDestroySwapchainKHR(device = 0x" << nouppercase <<  hex << HandleCast(device) << dec << ", swapchain = 0x" << nouppercase <<  hex << HandleCast(swapchain) << dec << ", pAllocator = 0x" << nouppercase <<  hex << HandleCast(pAllocator) << dec << ")\n";
    }
    else {
        (*outputStream) << "t{" << getTIDIndex() << "} vkDestroySwapchainKHR(device = address, swapchain = address, pAllocator = address)\n";
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1100
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
...
VK_LAYER_EXPORT VKAPI_ATTR VkResult VKAPI_CALL vkGetSwapchainImagesKHR(VkDevice device, VkSwapchainKHR swapchain, uint32_t* pSwapchainImageCount, VkImage* pSwapchainImages)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkGetSwapchainImagesKHR(device = 0x" << nouppercase <<  hex << HandleCast(device) << dec << ", swapchain = 0x" << nouppercase <<  hex << HandleCast(swapchain) << dec << ", " << (pSwapchainImageCount ? "*" : "") << "pSwapchainImageCount = 0x" << nouppercase <<  hex << (pSwapchainImageCount ? *pSwapchainImageCount : 0) << dec << ", pSwapchainImages = 0x" << nouppercase <<  hex << HandleCast(pSwapchainImages) << dec << ") = " << string_VkResult((VkResult)result) << endl;
    }
    else {
        (*outputStream) << "t{" << getTIDIndex() << "} vkGetSwapchainImagesKHR(device = address, swapchain = address, pSwapchainImageCount = address, pSwapchainImages = address) = " << string_VkResult((VkResult)result) << endl;
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1100
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
...
VK_LAYER_EXPORT VKAPI_ATTR VkResult VKAPI_CALL vkAcquireNextImageKHR(VkDevice device, VkSwapchainKHR swapchain, uint64_t timeout, VkSemaphore semaphore, VkFence fence, uint32_t* pImageIndex)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkAcquireNextImageKHR(device = 0x" << nouppercase <<  hex << HandleCast(device) << dec << ", swapchain = 0x" << nouppercase <<  hex << HandleCast(swapchain) << dec << ", timeout = 0x" << nouppercase <<  hex << timeout << dec << ", semaphore = 0x" << nouppercase <<  hex << HandleCast(semaphore) << dec << ", fence = 0x" << nouppercase <<  hex << HandleCast(fence) << dec << ", " << (pImageIndex ? "*" : "") << "pImageIndex = 0x" << nouppercase <<  hex << (pImageIndex ? *pImageIndex : 0) << dec << ") = " << string_VkResult((VkResult)result) << endl;
    }
    else {
        (*outputStream) << "t{" << getTIDIndex() << "} vkAcquireNextImageKHR(device = address, swapchain = address, timeout = address, semaphore = address, fence = address, pImageIndex = address) = " << string_VkResult((VkResult)result) << endl;
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1100
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
...
VK_LAYER_EXPORT VKAPI_ATTR VkResult VKAPI_CALL vkQueuePresentKHR(VkQueue queue, const VkPresentInfoKHR* pPresentInfo)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkQueuePresentKHR(queue = 0x" << nouppercase <<  hex << HandleCast(queue) << dec << ", pPresentInfo = 0x" << nouppercase <<  hex << HandleCast(pPresentInfo) << dec << ") = " << string_VkResult((VkResult)result) << endl;
    }
    else {
...
VK_LAYER_EXPORT VKAPI_ATTR VkResult VKAPI_CALL vkCreateWin32SurfaceKHR(VkInstance instance, const VkWin32SurfaceCreateInfoKHR* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkSurfaceKHR* pSurface)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkCreateWin32SurfaceKHR(instance = 0x" << nouppercase <<  hex << HandleCast(instance) << dec << ", pCreateInfo = 0x" << nouppercase <<  hex << HandleCast(pCreateInfo) << dec << ", pAllocator = 0x" << nouppercase <<  hex << HandleCast(pAllocator) << dec << ", " << (pSurface ? "*" : "") << "pSurface = 0x" << nouppercase <<  hex << (pSurface ? HandleCast(*pSurface) : 0) << dec << ") = " << string_VkResult((VkResult)result) << endl;
    }
    else {
        (*outputStream) << "t{" << getTIDIndex() << "} vkCreateWin32SurfaceKHR(instance = address, pCreateInfo = address, pAllocator = address, pSurface = address) = " << string_VkResult((VkResult)result) << endl;
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1100
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
...
VK_LAYER_EXPORT VKAPI_ATTR VkBool32 VKAPI_CALL vkGetPhysicalDeviceWin32PresentationSupportKHR(VkPhysicalDevice physicalDevice, uint32_t queueFamilyIndex)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkGetPhysicalDeviceWin32PresentationSupportKHR(physicalDevice = 0x" << nouppercase <<  hex << HandleCast(physicalDevice) << dec << ", queueFamilyIndex = 0x" << nouppercase <<  hex << queueFamilyIndex << dec << ")\n";
    }
    else {
        (*outputStream) << "t{" << getTIDIndex() << "} vkGetPhysicalDeviceWin32PresentationSupportKHR(physicalDevice = address, queueFamilyIndex = address)\n";
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1100
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
...
VK_LAYER_EXPORT VKAPI_ATTR VkResult VKAPI_CALL vkGetPhysicalDeviceDisplayPropertiesKHR(VkPhysicalDevice physicalDevice, uint32_t* pPropertyCount, VkDisplayPropertiesKHR* pProperties)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkGetPhysicalDeviceDisplayPropertiesKHR(physicalDevice = 0x" << nouppercase <<  hex << HandleCast(physicalDevice) << dec << ", " << (pPropertyCount ? "*" : "") << "pPropertyCount = 0x" << nouppercase <<  hex << (pPropertyCount ? *pPropertyCount : 0) << dec << ", pProperties = 0x" << nouppercase <<  hex << HandleCast(pProperties) << dec << ") = " << string_VkResult((VkResult)result) << endl;
    }
    else {
        (*outputStream) << "t{" << getTIDIndex() << "} vkGetPhysicalDeviceDisplayPropertiesKHR(physicalDevice = address, pPropertyCount = address, pProperties = address) = " << string_VkResult((VkResult)result) << endl;
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1100
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
...
VK_LAYER_EXPORT VKAPI_ATTR VkResult VKAPI_CALL vkGetPhysicalDeviceDisplayPlanePropertiesKHR(VkPhysicalDevice physicalDevice, uint32_t* pPropertyCount, VkDisplayPlanePropertiesKHR* pProperties)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkGetPhysicalDeviceDisplayPlanePropertiesKHR(physicalDevice = 0x" << nouppercase <<  hex << HandleCast(physicalDevice) << dec << ", " << (pPropertyCount ? "*" : "") << "pPropertyCount = 0x" << nouppercase <<  hex << (pPropertyCount ? *pPropertyCount : 0) << dec << ", pProperties = 0x" << nouppercase <<  hex << HandleCast(pProperties) << dec << ") = " << string_VkResult((VkResult)result) << endl;
    }
    else {
        (*outputStream) << "t{" << getTIDIndex() << "} vkGetPhysicalDeviceDisplayPlanePropertiesKHR(physicalDevice = address, pPropertyCount = address, pProperties = address) = " << string_VkResult((VkResult)result) << endl;
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1100
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
...
VK_LAYER_EXPORT VKAPI_ATTR VkResult VKAPI_CALL vkGetDisplayPlaneSupportedDisplaysKHR(VkPhysicalDevice physicalDevice, uint32_t planeIndex, uint32_t* pDisplayCount, VkDisplayKHR* pDisplays)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkGetDisplayPlaneSupportedDisplaysKHR(physicalDevice = 0x" << nouppercase <<  hex << HandleCast(physicalDevice) << dec << ", planeIndex = 0x" << nouppercase <<  hex << planeIndex << dec << ", " << (pDisplayCount ? "*" : "") << "pDisplayCount = 0x" << nouppercase <<  hex << (pDisplayCount ? *pDisplayCount : 0) << dec << ", " << (pDisplays ? "*" : "") << "pDisplays = 0x" << nouppercase <<  hex << (pDisplays ? HandleCast(*pDisplays) : 0) << dec << ") = " << string_VkResult((VkResult)result) << endl;
    }
    else {
        (*outputStream) << "t{" << getTIDIndex() << "} vkGetDisplayPlaneSupportedDisplaysKHR(physicalDevice = address, planeIndex = address, pDisplayCount = address, pDisplays = address) = " << string_VkResult((VkResult)result) << endl;
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1100
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
...
VK_LAYER_EXPORT VKAPI_ATTR VkResult VKAPI_CALL vkGetDisplayModePropertiesKHR(VkPhysicalDevice physicalDevice, VkDisplayKHR display, uint32_t* pPropertyCount, VkDisplayModePropertiesKHR* pProperties)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkGetDisplayModePropertiesKHR(physicalDevice = 0x" << nouppercase <<  hex << HandleCast(physicalDevice) << dec << ", display = 0x" << nouppercase <<  hex << HandleCast(display) << dec << ", " << (pPropertyCount ? "*" : "") << "pPropertyCount = 0x" << nouppercase <<  hex << (pPropertyCount ? *pPropertyCount : 0) << dec << ", pProperties = 0x" << nouppercase <<  hex << HandleCast(pProperties) << dec << ") = " << string_VkResult((VkResult)result) << endl;
    }
    else {
        (*outputStream) << "t{" << getTIDIndex() << "} vkGetDisplayModePropertiesKHR(physicalDevice = address, display = address, pPropertyCount = address, pProperties = address) = " << string_VkResult((VkResult)result) << endl;
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1100
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
...
VK_LAYER_EXPORT VKAPI_ATTR VkResult VKAPI_CALL vkCreateDisplayModeKHR(VkPhysicalDevice physicalDevice, VkDisplayKHR display, const VkDisplayModeCreateInfoKHR* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkDisplayModeKHR* pMode)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1040
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} vkCreateDisplayModeKHR(physicalDevice = 0x" << nouppercase <<  hex << HandleCast(physicalDevice) << dec << ", display = 0x" << nouppercase <<  hex << HandleCast(display) << dec << ", pCreateInfo = 0x" << nouppercase <<  hex << HandleCast(pCreateInfo) << dec << ", pAllocator = 0x" << nouppercase <<  hex << HandleCast(pAllocator) << dec << ", " << (pMode ? "*" : "") << "pMode = 0x" << nouppercase <<  hex << (pMode ? HandleCast(*pMode) : 0) << dec << ") = " << string_VkResult((VkResult)result) << endl;
    }
    else {
        (*outputStream) << "t{" << getTIDIndex() << "} vkCreateDisplayModeKHR(physicalDevice = address, display = address, pCreateInfo = address, pAllocator = address, pMode = address) = " << string_VkResult((VkResult)result) << endl;
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1100
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
