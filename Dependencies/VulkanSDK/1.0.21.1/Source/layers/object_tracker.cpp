...
std::unordered_map<uint64_t, OBJTRACK_NODE*> VkDisplayKHRMap;
std::unordered_map<uint64_t, OBJTRACK_NODE*> VkDisplayModeKHRMap;

// CODEGEN : file C:/releasebuild/LoaderAndValidationLayers/vk-layer-generate.py line #834
...
// CODEGEN : file C:/releasebuild/LoaderAndValidationLayers/vk-layer-generate.py line #859
...
// CODEGEN : file C:/releasebuild/LoaderAndValidationLayers/vk-layer-generate.py line #834
static void create_surface_khr(VkPhysicalDevice dispatchable_object, VkSurfaceKHR vkObj, VkDebugReportObjectTypeEXT objType)
{
    log_msg(mdd(dispatchable_object), VK_DEBUG_REPORT_INFORMATION_BIT_EXT, objType,(uint64_t)(vkObj), __LINE__, OBJTRACK_NONE, "OBJTRACK",
        "OBJ[%llu] : CREATE %s object 0x%" PRIxLEAST64 , object_track_index++, string_VkDebugReportObjectTypeEXT(objType),
        (uint64_t)(vkObj));
...
// CODEGEN : file C:/releasebuild/LoaderAndValidationLayers/vk-layer-generate.py line #859
static void destroy_surface_khr(VkPhysicalDevice dispatchable_object, VkSurfaceKHR object)
{
    uint64_t object_handle = (uint64_t)(object);
...
static void create_display_khr(VkPhysicalDevice dispatchable_object, VkDisplayKHR vkObj, VkDebugReportObjectTypeEXT objType)
{
    ...
    pNewObjNode->status  = OBJSTATUS_NONE;
    pNewObjNode->vkObj  = (uint64_t)(vkObj);
    VkDisplayKHRMap[(uint64_t)vkObj] = pNewObjNode;
    uint32_t objIndex = objTypeToIndex(objType);
    numObjs[objIndex]++;
    numTotalObjs++;
}
...
// CODEGEN : file C:/releasebuild/LoaderAndValidationLayers/vk-layer-generate.py line #859
static void destroy_display_khr(VkPhysicalDevice dispatchable_object, VkDisplayKHR object)
{
    uint64_t object_handle = (uint64_t)(object);
    auto it = VkDisplayKHRMap.find(object_handle);
    if (it != VkDisplayKHRMap.end()) {
        OBJTRACK_NODE* pNode = it->second;
        uint32_t objIndex = objTypeToIndex(pNode->objType);
        assert(numTotalObjs > 0);
        numTotalObjs--;
...
static void create_display_mode_khr(VkPhysicalDevice dispatchable_object, VkDisplayModeKHR vkObj, VkDebugReportObjectTypeEXT objType)
{
    ...
    pNewObjNode->status  = OBJSTATUS_NONE;
    pNewObjNode->vkObj  = (uint64_t)(vkObj);
    VkDisplayModeKHRMap[(uint64_t)vkObj] = pNewObjNode;
    uint32_t objIndex = objTypeToIndex(objType);
    numObjs[objIndex]++;
    numTotalObjs++;
}
...
// CODEGEN : file C:/releasebuild/LoaderAndValidationLayers/vk-layer-generate.py line #859
static void destroy_display_mode_khr(VkPhysicalDevice dispatchable_object, VkDisplayModeKHR object)
{
    uint64_t object_handle = (uint64_t)(object);
    auto it = VkDisplayModeKHRMap.find(object_handle);
    if (it != VkDisplayModeKHRMap.end()) {
        OBJTRACK_NODE* pNode = it->second;
        uint32_t objIndex = objTypeToIndex(pNode->objType);
        assert(numTotalObjs > 0);
        numTotalObjs--;
...
// CODEGEN : file C:/releasebuild/LoaderAndValidationLayers/vk-layer-generate.py line #899
...
// CODEGEN : file C:/releasebuild/LoaderAndValidationLayers/vk-layer-generate.py line #916
...
static bool validate_display_mode_khr(VkInstance dispatchable_object, VkDisplayModeKHR object, VkDebugReportObjectTypeEXT objType, bool null_allowed)
{
    if (null_allowed && (object == VK_NULL_HANDLE))
        return false;
    if (VkDisplayModeKHRMap.find((uint64_t)object) == VkDisplayModeKHRMap.end()) {
        return log_msg(mdd(dispatchable_object), VK_DEBUG_REPORT_ERROR_BIT_EXT, objType, (uint64_t)(object), __LINE__, OBJTRACK_INVALID_OBJECT, "OBJTRACK",
            "Invalid VkDisplayModeKHR Object 0x%" PRIx64, (uint64_t)(object));
    }
    return false;
}
// CODEGEN : file C:/releasebuild/LoaderAndValidationLayers/vk-layer-generate.py line #916
...
static bool validate_display_khr(VkPhysicalDevice dispatchable_object, VkDisplayKHR object, VkDebugReportObjectTypeEXT objType, bool null_allowed)
{
    if (null_allowed && (object == VK_NULL_HANDLE))
        return false;
    if (VkDisplayKHRMap.find((uint64_t)object) == VkDisplayKHRMap.end()) {
        return log_msg(mdd(dispatchable_object), VK_DEBUG_REPORT_ERROR_BIT_EXT, objType, (uint64_t)(object), __LINE__, OBJTRACK_INVALID_OBJECT, "OBJTRACK",
            "Invalid VkDisplayKHR Object 0x%" PRIx64, (uint64_t)(object));
    }
    return false;
}
// CODEGEN : file C:/releasebuild/LoaderAndValidationLayers/vk-layer-generate.py line #916
static bool validate_display_mode_khr(VkPhysicalDevice dispatchable_object, VkDisplayModeKHR object, VkDebugReportObjectTypeEXT objType, bool null_allowed)
{
    if (null_allowed && (object == VK_NULL_HANDLE))
        return false;
    if (VkDisplayModeKHRMap.find((uint64_t)object) == VkDisplayModeKHRMap.end()) {
...
// CODEGEN : file C:/releasebuild/LoaderAndValidationLayers/vk-layer-generate.py line #1025
...
// CODEGEN : file C:/releasebuild/LoaderAndValidationLayers/vk-layer-generate.py line #1282
...
// CODEGEN : file C:/releasebuild/LoaderAndValidationLayers/vk-layer-generate.py line #1159
...
// CODEGEN : file C:/releasebuild/LoaderAndValidationLayers/vk-layer-generate.py line #1159
        ...
        if (pSubmits) {
// CODEGEN : file C:/releasebuild/LoaderAndValidationLayers/vk-layer-generate.py line #1115
...
// CODEGEN : file C:/releasebuild/LoaderAndValidationLayers/vk-layer-generate.py line #1151
...
// CODEGEN : file C:/releasebuild/LoaderAndValidationLayers/vk-layer-generate.py line #1316
...
VKAPI_ATTR VkResult VKAPI_CALL GetPhysicalDeviceDisplayPlanePropertiesKHR(VkPhysicalDevice physicalDevice, uint32_t* pPropertyCount, VkDisplayPlanePropertiesKHR* pProperties)
{
    ...
    {
        std::lock_guard<std::mutex> lock(global_lock);
// objects to validate: ['pProperties[pPropertyCount]', 'physicalDevice']
        if (pProperties) {
// CODEGEN : file C:/releasebuild/LoaderAndValidationLayers/vk-layer-generate.py line #1115
            for (uint32_t idx0=0; idx0<*pPropertyCount; ++idx0) {
                if (pProperties[idx0].currentDisplay) {
// CODEGEN : file C:/releasebuild/LoaderAndValidationLayers/vk-layer-generate.py line #1151
                    skipCall |= validate_display_khr(physicalDevice, pProperties[idx0].currentDisplay, VK_DEBUG_REPORT_OBJECT_TYPE_UNKNOWN_EXT, false);
                }
            }
        }
        if (physicalDevice) {
// CODEGEN : file C:/releasebuild/LoaderAndValidationLayers/vk-layer-generate.py line #1151
    ...
    if (skipCall)
        return VK_ERROR_VALIDATION_FAILED_EXT;
    VkResult result = get_dispatch_table(object_tracker_instance_table_map, physicalDevice)->GetPhysicalDeviceDisplayPlanePropertiesKHR(physicalDevice, pPropertyCount, pProperties);
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL CreateDisplayModeKHR(VkPhysicalDevice physicalDevice, VkDisplayKHR display, const VkDisplayModeCreateInfoKHR* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkDisplayModeKHR* pMode)
{
    ...
    {
        std::lock_guard<std::mutex> lock(global_lock);
// objects to validate: ['display', 'physicalDevice']
// CODEGEN : file C:/releasebuild/LoaderAndValidationLayers/vk-layer-generate.py line #1159
...
// CODEGEN : file C:/releasebuild/LoaderAndValidationLayers/vk-layer-generate.py line #1159
    ...
    if (skipCall)
        return VK_ERROR_VALIDATION_FAILED_EXT;
    VkResult result = get_dispatch_table(object_tracker_instance_table_map, physicalDevice)->CreateDisplayModeKHR(physicalDevice, display, pCreateInfo, pAllocator, pMode);
    {
        std::lock_guard<std::mutex> lock(global_lock);
        if (result == VK_SUCCESS) {
            create_display_mode_khr(physicalDevice, *pMode, VK_DEBUG_REPORT_OBJECT_TYPE_UNKNOWN_EXT);
        }
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL GetDisplayPlaneCapabilitiesKHR(VkPhysicalDevice physicalDevice, VkDisplayModeKHR mode, uint32_t planeIndex, VkDisplayPlaneCapabilitiesKHR* pCapabilities)
{
    ...
    {
        std::lock_guard<std::mutex> lock(global_lock);
// objects to validate: ['mode', 'physicalDevice']
// CODEGEN : file C:/releasebuild/LoaderAndValidationLayers/vk-layer-generate.py line #1159
        skipCall |= validate_display_mode_khr(physicalDevice, mode, VK_DEBUG_REPORT_OBJECT_TYPE_UNKNOWN_EXT, false);
// CODEGEN : file C:/releasebuild/LoaderAndValidationLayers/vk-layer-generate.py line #1159
        skipCall |= validate_physical_device(physicalDevice, physicalDevice, VK_DEBUG_REPORT_OBJECT_TYPE_PHYSICAL_DEVICE_EXT, false);
    }
    if (skipCall)
        return VK_ERROR_VALIDATION_FAILED_EXT;
    VkResult result = get_dispatch_table(object_tracker_instance_table_map, physicalDevice)->GetDisplayPlaneCapabilitiesKHR(physicalDevice, mode, planeIndex, pCapabilities);
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL CreateDisplayPlaneSurfaceKHR(VkInstance instance, const VkDisplaySurfaceCreateInfoKHR* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkSurfaceKHR* pSurface)
{
    ...
    {
        std::lock_guard<std::mutex> lock(global_lock);
// objects to validate: ['instance', 'pCreateInfo']
// CODEGEN : file C:/releasebuild/LoaderAndValidationLayers/vk-layer-generate.py line #1159
        skipCall |= validate_instance(instance, instance, VK_DEBUG_REPORT_OBJECT_TYPE_INSTANCE_EXT, false);
        if (pCreateInfo) {
// CODEGEN : file C:/releasebuild/LoaderAndValidationLayers/vk-layer-generate.py line #1159
            skipCall |= validate_display_mode_khr(instance, pCreateInfo->displayMode, VK_DEBUG_REPORT_OBJECT_TYPE_UNKNOWN_EXT, false);
        }
    }
    if (skipCall)
        return VK_ERROR_VALIDATION_FAILED_EXT;
    VkResult result = get_dispatch_table(object_tracker_instance_table_map, instance)->CreateDisplayPlaneSurfaceKHR(instance, pCreateInfo, pAllocator, pSurface);
    {
        std::lock_guard<std::mutex> lock(global_lock);
        if (result == VK_SUCCESS) {
            create_surface_khr(instance, *pSurface, VK_DEBUG_REPORT_OBJECT_TYPE_SURFACE_KHR_EXT);
...
// CODEGEN : file C:/releasebuild/LoaderAndValidationLayers/vk-layer-generate.py line #471
...
// CODEGEN : file C:/releasebuild/LoaderAndValidationLayers/vk-layer-generate.py line #497
// CODEGEN : file C:/releasebuild/LoaderAndValidationLayers/vk-layer-generate.py line #298
...
// CODEGEN : file C:/releasebuild/LoaderAndValidationLayers/vk-layer-generate.py line #330
...
// CODEGEN : file C:/releasebuild/LoaderAndValidationLayers/vk-layer-generate.py line #346
...
// CODEGEN : file C:/releasebuild/LoaderAndValidationLayers/vk-layer-generate.py line #505
                                                                  ...
                                                                  VkExtensionProperties *pProperties)
{
    ...
    VkLayerInstanceDispatchTable* pTable = get_dispatch_table(object_tracker_instance_table_map, physicalDevice);
    return pTable->EnumerateDeviceExtensionProperties(physicalDevice, NULL, pCount, pProperties);
}

// CODEGEN : file C:/releasebuild/LoaderAndValidationLayers/vk-layer-generate.py line #573
...
// CODEGEN : file C:/releasebuild/LoaderAndValidationLayers/vk-layer-generate.py line #613
...
// CODEGEN : file C:/releasebuild/LoaderAndValidationLayers/vk-layer-generate.py line #360
...
// CODEGEN : file C:/releasebuild/LoaderAndValidationLayers/vk-layer-generate.py line #385
